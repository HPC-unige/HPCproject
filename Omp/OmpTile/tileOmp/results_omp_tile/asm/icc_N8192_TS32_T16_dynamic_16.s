...
results_omp_tile/bin/icc_N8192_TS32_T16_dynamic_16:     file format elf64-x86-64
...
0000000000402370 <main>:
  ...
  4023d2:	00 
  4023d3:	ba 00 00 00 20       	mov    $0x20000000,%edx
  4023d8:	b8 00 20 00 00       	mov    $0x2000,%eax
  4023dd:	b9 ff 1f 00 00       	mov    $0x1fff,%ecx
  4023e2:	33 db                	xor    %ebx,%ebx
  4023e4:	c7 47 bc 00 20 00 00 	movl   $0x2000,-0x44(%rdi)

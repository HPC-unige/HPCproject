...
results_omp_tile/bin/icx_N6144_TS128_T16_dynamic_16:     file format elf64-x86-64
...
0000000000401610 <main>:
  ...
  40162a:	e8 01 0d 00 00       	call   402330 <__intel_new_feature_proc_init>
  ...
  401654:	ba 00 00 00 12       	mov    $0x12000000,%edx
  ...
  40166c:	ba 00 00 00 12       	mov    $0x12000000,%edx
  ...
  401684:	ba 00 00 00 12       	mov    $0x12000000,%edx
  ...
  4016f0:	48 c7 44 24 28 ff 17 	movq   $0x17ff,0x28(%rsp)
  4016f7:	00 00 
  ...
  40170d:	b9 00 18 00 00       	mov    $0x1800,%ecx
  ...
  401745:	48 c7 44 24 30 ff 08 	movq   $0x8ff,0x30(%rsp)
  40174c:	00 00 
  ...
  401761:	b9 00 18 00 00       	mov    $0x1800,%ecx
  ...
  4017c6:	ba 00 18 00 00       	mov    $0x1800,%edx
  ...
  4017fd:	ba 00 18 00 00       	mov    $0x1800,%edx
  ...
  4019ee:	49 81 c6 00 c0 00 00 	add    $0xc000,%r14
...
0000000000401aa0 <main.extracted.18>:
  ...
  401ace:	00 00 
  401ad0:	48 c7 44 24 10 ff 08 	movq   $0x8ff,0x10(%rsp)
  401ad7:	00 00 
  ...
  401aef:	41 b8 ff 08 00 00    	mov    $0x8ff,%r8d
  ...
  401b57:	0f 84 22 02 00 00    	je     401d7f <main.extracted.18+0x2df>
  401b5d:	48 8b 54 24 18       	mov    0x18(%rsp),%rdx
  401b62:	48 8b 44 24 10       	mov    0x10(%rsp),%rax
  401b67:	48 39 c2             	cmp    %rax,%rdx
  401b6a:	0f 87 0f 02 00 00    	ja     401d7f <main.extracted.18+0x2df>
  ...
  401bd9:	48 c1 ea 03          	shr    $0x3,%rdx
  401bdd:	01 c2                	add    %eax,%edx
  401bdf:	89 d0                	mov    %edx,%eax
  401be1:	c1 e0 04             	shl    $0x4,%eax
  401be4:	8d 04 40             	lea    (%rax,%rax,2),%eax
  401be7:	29 c1                	sub    %eax,%ecx
  401be9:	89 d6                	mov    %edx,%esi
  401beb:	c1 e6 07             	shl    $0x7,%esi
  401bee:	83 fa 2f             	cmp    $0x2f,%edx
  401bf1:	b8 2f 00 00 00       	mov    $0x2f,%eax
  401bf6:	0f 4d d0             	cmovge %eax,%edx
  401bf9:	c1 e2 07             	shl    $0x7,%edx
  401bfc:	83 ea 80             	sub    $0xffffff80,%edx
  401bff:	81 fe 80 17 00 00    	cmp    $0x1780,%esi
  401c05:	41 b9 80 17 00 00    	mov    $0x1780,%r9d
  401c0b:	44 0f 4c ce          	cmovl  %esi,%r9d
  401c0f:	41 29 f1             	sub    %esi,%r9d
  401c12:	41 83 c9 7f          	or     $0x7f,%r9d
  401c16:	89 74 24 24          	mov    %esi,0x24(%rsp)
  401c1a:	48 63 f6             	movslq %esi,%rsi
  401c1d:	48 8d 3c 76          	lea    (%rsi,%rsi,2),%rdi
  401c21:	48 c1 e6 0b          	shl    $0xb,%rsi
  401c25:	4c 8d 14 76          	lea    (%rsi,%rsi,2),%r10
  401c29:	c1 e1 07             	shl    $0x7,%ecx
  401c2c:	48 63 c9             	movslq %ecx,%rcx
  401c2f:	48 c1 e7 0e          	shl    $0xe,%rdi
  401c33:	48 8d 04 cf          	lea    (%rdi,%rcx,8),%rax
  401c37:	48 89 44 24 60       	mov    %rax,0x60(%rsp)
  401c3c:	4c 8d 1c cd 40 00 00 	lea    0x40(,%rcx,8),%r11
  401c43:	00 
  401c44:	31 ed                	xor    %ebp,%ebp
  401c46:	eb 1d                	jmp    401c65 <main.extracted.18+0x1c5>
  401c48:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
  401c4f:	00 
  401c50:	8d 45 01             	lea    0x1(%rbp),%eax
  401c53:	49 81 c3 00 00 60 00 	add    $0x600000,%r11
  401c5a:	83 fd 2f             	cmp    $0x2f,%ebp
  401c5d:	89 c5                	mov    %eax,%ebp
  401c5f:	0f 84 3b ff ff ff    	je     401ba0 <main.extracted.18+0x100>
  401c65:	39 54 24 24          	cmp    %edx,0x24(%rsp)
  401c69:	7d e5                	jge    401c50 <main.extracted.18+0x1b0>
  401c6b:	89 e9                	mov    %ebp,%ecx
  401c6d:	c1 e1 07             	shl    $0x7,%ecx
  401c70:	8d b1 80 00 00 00    	lea    0x80(%rcx),%esi
  401c76:	31 ff                	xor    %edi,%edi
  401c78:	81 fe 00 18 00 00    	cmp    $0x1800,%esi
  401c7e:	40 0f 9c c7          	setl   %dil
  401c82:	31 f6                	xor    %esi,%esi
  401c84:	81 f9 00 18 00 00    	cmp    $0x1800,%ecx
  401c8a:	40 0f 9c c6          	setl   %sil
  401c8e:	40 38 fe             	cmp    %dil,%sil
  401c91:	0f 47 fe             	cmova  %esi,%edi
  401c94:	40 80 ff 01          	cmp    $0x1,%dil
  401c98:	75 b6                	jne    401c50 <main.extracted.18+0x1b0>
  401c9a:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
  401c9f:	4c 8b 20             	mov    (%rax),%r12
  401ca2:	41 89 ed             	mov    %ebp,%r13d
  401ca5:	49 c1 e5 07          	shl    $0x7,%r13
  401ca9:	48 8b 44 24 58       	mov    0x58(%rsp),%rax
  401cae:	48 8b 08             	mov    (%rax),%rcx
  401cb1:	48 8b 44 24 60       	mov    0x60(%rsp),%rax
  401cb6:	48 8d 74 01 40       	lea    0x40(%rcx,%rax,1),%rsi
  401cbb:	48 8b 44 24 50       	mov    0x50(%rsp),%rax
  401cc0:	4c 8b 38             	mov    (%rax),%r15
  401cc3:	4d 01 df             	add    %r11,%r15
  401cc6:	31 db                	xor    %ebx,%ebx
  401cc8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
  401ccf:	00 
  401cd0:	4c 8d 34 5b          	lea    (%rbx,%rbx,2),%r14
  401cd4:	49 c1 e6 0b          	shl    $0xb,%r14
  401cd8:	4d 01 ee             	add    %r13,%r14
  401cdb:	4c 89 ff             	mov    %r15,%rdi
  401cde:	45 31 c0             	xor    %r8d,%r8d
  401ce1:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 cs nopw 0x0(%rax,%rax,1)
  401ce8:	0f 1f 84 00 00 00 00 
  401cef:	00 
  401cf0:	4b 8d 0c 06          	lea    (%r14,%r8,1),%rcx
  401cf4:	4c 01 d1             	add    %r10,%rcx
  401cf7:	c4 c2 7d 19 04 cc    	vbroadcastsd (%r12,%rcx,8),%ymm0
  401cfd:	31 c9                	xor    %ecx,%ecx
  401cff:	90                   	nop
  401d00:	c5 fd 10 4c cf c0    	vmovupd -0x40(%rdi,%rcx,8),%ymm1
  401d06:	c5 fd 10 54 cf e0    	vmovupd -0x20(%rdi,%rcx,8),%ymm2
  401d0c:	c4 e2 fd a8 54 ce e0 	vfmadd213pd -0x20(%rsi,%rcx,8),%ymm0,%ymm2
  401d13:	c4 e2 fd a8 4c ce c0 	vfmadd213pd -0x40(%rsi,%rcx,8),%ymm0,%ymm1
  401d1a:	c5 fd 11 4c ce c0    	vmovupd %ymm1,-0x40(%rsi,%rcx,8)
  401d20:	c5 fd 11 54 ce e0    	vmovupd %ymm2,-0x20(%rsi,%rcx,8)
  401d26:	c5 fd 10 0c cf       	vmovupd (%rdi,%rcx,8),%ymm1
  401d2b:	c5 fd 10 54 cf 20    	vmovupd 0x20(%rdi,%rcx,8),%ymm2
  401d31:	c4 e2 fd a8 54 ce 20 	vfmadd213pd 0x20(%rsi,%rcx,8),%ymm0,%ymm2
  401d38:	c4 e2 fd a8 0c ce    	vfmadd213pd (%rsi,%rcx,8),%ymm0,%ymm1
  401d3e:	c5 fd 11 0c ce       	vmovupd %ymm1,(%rsi,%rcx,8)
  401d43:	c5 fd 11 54 ce 20    	vmovupd %ymm2,0x20(%rsi,%rcx,8)
  401d49:	48 83 c1 10          	add    $0x10,%rcx
  401d4d:	8d 41 f8             	lea    -0x8(%rcx),%eax
  401d50:	83 f8 78             	cmp    $0x78,%eax
  401d53:	72 ab                	jb     401d00 <main.extracted.18+0x260>
  401d55:	48 81 c7 00 c0 00 00 	add    $0xc000,%rdi
  401d5c:	49 83 f8 7f          	cmp    $0x7f,%r8
  401d60:	4d 8d 40 01          	lea    0x1(%r8),%r8
  401d64:	75 8a                	jne    401cf0 <main.extracted.18+0x250>
  401d66:	48 81 c6 00 c0 00 00 	add    $0xc000,%rsi
  401d6d:	4c 39 cb             	cmp    %r9,%rbx
  401d70:	48 8d 5b 01          	lea    0x1(%rbx),%rbx
  401d74:	0f 85 56 ff ff ff    	jne    401cd0 <main.extracted.18+0x230>
  401d7a:	e9 d1 fe ff ff       	jmp    401c50 <main.extracted.18+0x1b0>
  401d7f:	48 83 c4 68          	add    $0x68,%rsp
  401d83:	5b                   	pop    %rbx
...
0000000000401d90 <main.extracted.25>:
  ...
  401db7:	00 
  401db8:	c7 04 24 ff 17 00 00 	movl   $0x17ff,(%rsp)
  ...
  401e02:	0f 87 bd 00 00 00    	ja     401ec5 <main.extracted.25+0x135>
  ...
  401e18:	75 50                	jne    401e6a <main.extracted.25+0xda>
  401e1a:	48 c1 e0 0b          	shl    $0xb,%rax
  401e1e:	48 8d 04 40          	lea    (%rax,%rax,2),%rax
  401e22:	48 8d 0c 49          	lea    (%rcx,%rcx,2),%rcx
  401e26:	48 c1 e1 0b          	shl    $0xb,%rcx
  401e2a:	48 81 c1 00 18 00 00 	add    $0x1800,%rcx
  401e31:	48 ba 00 00 00 00 00 	movabs $0x4000000000000000,%rdx
  401e38:	00 00 40 
  401e3b:	48 be 00 00 00 00 00 	movabs $0x4008000000000000,%rsi
  401e42:	00 08 40 
  401e45:	66 66 2e 0f 1f 84 00 	data16 cs nopw 0x0(%rax,%rax,1)
  401e4c:	00 00 00 00 
  401e50:	49 89 14 c4          	mov    %rdx,(%r12,%rax,8)
  401e54:	49 89 34 c7          	mov    %rsi,(%r15,%rax,8)
  401e58:	48 c7 04 c7 00 00 00 	movq   $0x0,(%rdi,%rax,8)
  401e5f:	00 
  401e60:	48 ff c0             	inc    %rax
  401e63:	48 39 c1             	cmp    %rax,%rcx
  401e66:	75 e8                	jne    401e50 <main.extracted.25+0xc0>
  401e68:	eb 5b                	jmp    401ec5 <main.extracted.25+0x135>
  401e6a:	48 29 c2             	sub    %rax,%rdx
  401e6d:	48 89 d1             	mov    %rdx,%rcx
  401e70:	48 c1 e1 0b          	shl    $0xb,%rcx
  401e74:	4c 8d 34 49          	lea    (%rcx,%rcx,2),%r14
  401e78:	48 c1 e0 0e          	shl    $0xe,%rax
  401e7c:	4c 8d 2c 40          	lea    (%rax,%rax,2),%r13
  401e80:	4c 01 ef             	add    %r13,%rdi
  401e83:	48 c1 e2 0e          	shl    $0xe,%rdx
  401e87:	48 8d 14 52          	lea    (%rdx,%rdx,2),%rdx
  401e8b:	31 f6                	xor    %esi,%esi
  401e8d:	e8 7e 00 00 00       	call   401f10 <_intel_fast_memset>
  401e92:	31 c0                	xor    %eax,%eax
  401e94:	4d 01 ef             	add    %r13,%r15
  401e97:	4d 01 ec             	add    %r13,%r12
  401e9a:	c4 e2 7d 19 05 a5 71 	vbroadcastsd 0x71a5(%rip),%ymm0        # 409048 <_IO_stdin_used+0x48>
  401ea1:	00 00 
  401ea3:	c4 e2 7d 19 0d a4 71 	vbroadcastsd 0x71a4(%rip),%ymm1        # 409050 <_IO_stdin_used+0x50>
  401eaa:	00 00 
  401eac:	0f 1f 40 00          	nopl   0x0(%rax)
  401eb0:	c4 c1 7c 11 04 c4    	vmovups %ymm0,(%r12,%rax,8)
  401eb6:	c4 c1 7c 11 0c c7    	vmovups %ymm1,(%r15,%rax,8)
  401ebc:	48 83 c0 04          	add    $0x4,%rax
  401ec0:	4c 39 f0             	cmp    %r14,%rax
  401ec3:	7c eb                	jl     401eb0 <main.extracted.25+0x120>
  401ec5:	bf 00 c2 40 00       	mov    $0x40c200,%edi
  401eca:	89 de                	mov    %ebx,%esi
  401ecc:	48 83 c4 10          	add    $0x10,%rsp
  401ed0:	5b                   	pop    %rbx
  401ed1:	41 5c                	pop    %r12
  401ed3:	41 5d                	pop    %r13
  401ed5:	41 5e                	pop    %r14
  401ed7:	41 5f                	pop    %r15
  401ed9:	c5 f8 77             	vzeroupper
  401edc:	e9 af f1 ff ff       	jmp    401090 <__kmpc_for_static_fini@plt>
  401ee1:	0f 1f 00             	nopl   (%rax)
  401ee4:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  401eeb:	00 00 00 
  401eee:	66 90                	xchg   %ax,%ax

0000000000401ef0 <__intel_get_fast_memset_impl.V>:
  401ef0:	48 c7 c0 50 3d 40 00 	mov    $0x403d50,%rax
  401ef7:	c3                   	ret
  401ef8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
  401eff:	00 

0000000000401f00 <__intel_get_fast_memset_impl.Z>:
  401f00:	48 c7 c0 80 24 40 00 	mov    $0x402480,%rax
  401f07:	c3                   	ret
  401f08:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
  401f0f:	00 

0000000000401f10 <_intel_fast_memset>:
  401f10:	f3 0f 1e fa          	endbr64
  401f14:	48 8b 05 75 a3 00 00 	mov    0xa375(%rip),%rax        # 40c290 <__real_memset_impl>
  401f1b:	48 85 c0             	test   %rax,%rax
  401f1e:	0f 84 0c 00 00 00    	je     401f30 <__real_memset_impl_setup>
  401f24:	ff e0                	jmp    *%rax
  401f26:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  401f2d:	00 00 00 

0000000000401f30 <__real_memset_impl_setup>:
  401f30:	55                   	push   %rbp
  401f31:	41 56                	push   %r14
  401f33:	53                   	push   %rbx
  401f34:	48 89 d3             	mov    %rdx,%rbx
  401f37:	89 f5                	mov    %esi,%ebp
  401f39:	49 89 fe             	mov    %rdi,%r14
  401f3c:	48 c7 c1 b0 c2 40 00 	mov    $0x40c2b0,%rcx
  401f43:	48 8b 01             	mov    (%rcx),%rax
  401f46:	48 85 c0             	test   %rax,%rax
  401f49:	75 12                	jne    401f5d <__real_memset_impl_setup+0x2d>
  401f4b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  401f50:	e8 8b 4b 00 00       	call   406ae0 <__intel_cpu_features_init_x>
  401f55:	48 8b 01             	mov    (%rcx),%rax
  401f58:	48 85 c0             	test   %rax,%rax
  401f5b:	74 f3                	je     401f50 <__real_memset_impl_setup+0x20>
  401f5d:	48 89 c1             	mov    %rax,%rcx
  401f60:	48 f7 d1             	not    %rcx
  401f63:	48 ba ec 9f 9d 18 07 	movabs $0x7189d9fec,%rdx
  401f6a:	00 00 00 
  401f6d:	48 85 d1             	test   %rdx,%rcx
  401f70:	75 07                	jne    401f79 <__real_memset_impl_setup+0x49>
  401f72:	e8 89 ff ff ff       	call   401f00 <__intel_get_fast_memset_impl.Z>
  401f77:	eb 29                	jmp    401fa2 <__real_memset_impl_setup+0x72>
  401f79:	89 c1                	mov    %eax,%ecx
  401f7b:	f7 d1                	not    %ecx
  401f7d:	f7 c1 ec 9f 9d 00    	test   $0x9d9fec,%ecx
  401f83:	75 07                	jne    401f8c <__real_memset_impl_setup+0x5c>
  401f85:	e8 66 ff ff ff       	call   401ef0 <__intel_get_fast_memset_impl.V>
  401f8a:	eb 16                	jmp    401fa2 <__real_memset_impl_setup+0x72>
  401f8c:	f7 d0                	not    %eax
  401f8e:	a8 6c                	test   $0x6c,%al
  401f90:	75 09                	jne    401f9b <__real_memset_impl_setup+0x6b>
  401f92:	48 c7 c0 20 4e 40 00 	mov    $0x404e20,%rax
  401f99:	eb 07                	jmp    401fa2 <__real_memset_impl_setup+0x72>
  401f9b:	48 8b 05 0e a0 00 00 	mov    0xa00e(%rip),%rax        # 40bfb0 <memset@GLIBC_2.2.5>
  401fa2:	48 89 05 e7 a2 00 00 	mov    %rax,0xa2e7(%rip)        # 40c290 <__real_memset_impl>
  401fa9:	4c 89 f7             	mov    %r14,%rdi
  401fac:	89 ee                	mov    %ebp,%esi
  401fae:	48 89 da             	mov    %rbx,%rdx
  401fb1:	5b                   	pop    %rbx
  401fb2:	41 5e                	pop    %r14
  401fb4:	5d                   	pop    %rbp
  401fb5:	ff e0                	jmp    *%rax
  401fb7:	90                   	nop
  401fb8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
  401fbf:	00 

0000000000401fc0 <__intel_new_feature_proc_init_n>:
  401fc0:	f3 0f 1e fa          	endbr64
  401fc4:	55                   	push   %rbp
  401fc5:	41 57                	push   %r15
  401fc7:	41 56                	push   %r14
  401fc9:	41 55                	push   %r13
  401fcb:	41 54                	push   %r12
  401fcd:	53                   	push   %rbx
  401fce:	48 81 ec 38 04 00 00 	sub    $0x438,%rsp
  401fd5:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401fdc:	00 00 
  401fde:	48 89 84 24 30 04 00 	mov    %rax,0x430(%rsp)
  401fe5:	00 
  401fe6:	0f 57 c0             	xorps  %xmm0,%xmm0
  401fe9:	0f 29 44 24 10       	movaps %xmm0,0x10(%rsp)
  401fee:	48 c7 c1 a0 c2 40 00 	mov    $0x40c2a0,%rcx
  401ff5:	48 83 39 00          	cmpq   $0x0,(%rcx)
  401ff9:	75 17                	jne    402012 <__intel_new_feature_proc_init_n+0x52>
  401ffb:	e8 00 40 00 00       	call   406000 <__intel_cpu_features_init>
  402000:	85 c0                	test   %eax,%eax
  402002:	0f 85 0b 02 00 00    	jne    402213 <__intel_new_feature_proc_init_n+0x253>
  402008:	48 83 39 00          	cmpq   $0x0,(%rcx)
  40200c:	0f 84 01 02 00 00    	je     402213 <__intel_new_feature_proc_init_n+0x253>
  402012:	83 ff 02             	cmp    $0x2,%edi
  402015:	7d 38                	jge    40204f <__intel_new_feature_proc_init_n+0x8f>
  402017:	48 63 c7             	movslq %edi,%rax
  40201a:	48 8b 0c c1          	mov    (%rcx,%rax,8),%rcx
  40201e:	48 f7 d1             	not    %rcx
  402021:	48 85 ce             	test   %rcx,%rsi
  402024:	75 48                	jne    40206e <__intel_new_feature_proc_init_n+0xae>
  402026:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  40202d:	00 00 
  40202f:	48 3b 84 24 30 04 00 	cmp    0x430(%rsp),%rax
  402036:	00 
  402037:	0f 85 e8 02 00 00    	jne    402325 <__intel_new_feature_proc_init_n+0x365>
  40203d:	48 81 c4 38 04 00 00 	add    $0x438,%rsp
  402044:	5b                   	pop    %rbx
  ...
  402056:	31 d2                	xor    %edx,%edx
  402058:	31 c0                	xor    %eax,%eax
  40205a:	e8 51 61 00 00       	call   4081b0 <__libirc_print>
  40205f:	bf 01 00 00 00       	mov    $0x1,%edi
  402064:	be 3a 00 00 00       	mov    $0x3a,%esi
  402069:	e9 bf 01 00 00       	jmp    40222d <__intel_new_feature_proc_init_n+0x26d>
  40206e:	48 21 f1             	and    %rsi,%rcx
  402071:	48 89 4c c4 10       	mov    %rcx,0x10(%rsp,%rax,8)
  402076:	45 31 ff             	xor    %r15d,%r15d
  402079:	bf 39 00 00 00       	mov    $0x39,%edi
  40207e:	31 f6                	xor    %esi,%esi
  402080:	31 c0                	xor    %eax,%eax
  402082:	e8 e9 5e 00 00       	call   407f70 <__libirc_get_msg>
  402087:	48 89 04 24          	mov    %rax,(%rsp)
  40208b:	c6 44 24 30 00       	movb   $0x0,0x30(%rsp)
  402090:	bd 01 00 00 00       	mov    $0x1,%ebp
  402095:	4c 8d 64 24 10       	lea    0x10(%rsp),%r12
  40209a:	4c 8d 6c 24 30       	lea    0x30(%rsp),%r13
  40209f:	31 db                	xor    %ebx,%ebx
  4020a1:	eb 31                	jmp    4020d4 <__intel_new_feature_proc_init_n+0x114>
  4020a3:	b8 ff 03 00 00       	mov    $0x3ff,%eax
  4020a8:	44 29 f8             	sub    %r15d,%eax
  4020ab:	48 63 d0             	movslq %eax,%rdx
  4020ae:	b9 00 04 00 00       	mov    $0x400,%ecx
  4020b3:	4c 89 ef             	mov    %r13,%rdi
  4020b6:	4c 89 f6             	mov    %r14,%rsi
  4020b9:	e8 32 f1 ff ff       	call   4011f0 <__strncat_chk@plt>
  4020be:	4c 89 ef             	mov    %r13,%rdi
  4020c1:	e8 3a f0 ff ff       	call   401100 <strlen@plt>
  4020c6:	49 89 c7             	mov    %rax,%r15
  4020c9:	ff c5                	inc    %ebp
  4020cb:	83 fd 47             	cmp    $0x47,%ebp
  4020ce:	0f 84 26 01 00 00    	je     4021fa <__intel_new_feature_proc_init_n+0x23a>
  4020d4:	89 e8                	mov    %ebp,%eax
  4020d6:	e8 15 55 00 00       	call   4075f0 <__libirc_get_feature_bitpos>
  4020db:	85 c0                	test   %eax,%eax
  4020dd:	78 ea                	js     4020c9 <__intel_new_feature_proc_init_n+0x109>
  4020df:	4c 89 e7             	mov    %r12,%rdi
  4020e2:	89 ee                	mov    %ebp,%esi
  4020e4:	e8 47 55 00 00       	call   407630 <__libirc_get_cpu_feature>
  4020e9:	85 c0                	test   %eax,%eax
  4020eb:	74 dc                	je     4020c9 <__intel_new_feature_proc_init_n+0x109>
  4020ed:	4c 89 e7             	mov    %r12,%rdi
  4020f0:	89 ee                	mov    %ebp,%esi
  4020f2:	e8 39 55 00 00       	call   407630 <__libirc_get_cpu_feature>
  4020f7:	85 c0                	test   %eax,%eax
  4020f9:	0f 88 e6 00 00 00    	js     4021e5 <__intel_new_feature_proc_init_n+0x225>
  4020ff:	89 ef                	mov    %ebp,%edi
  402101:	e8 fa 49 00 00       	call   406b00 <__libirc_get_feature_name>
  402106:	48 85 c0             	test   %rax,%rax
  402109:	0f 84 d6 00 00 00    	je     4021e5 <__intel_new_feature_proc_init_n+0x225>
  40210f:	49 89 c6             	mov    %rax,%r14
  402112:	80 38 00             	cmpb   $0x0,(%rax)
  402115:	0f 84 ca 00 00 00    	je     4021e5 <__intel_new_feature_proc_init_n+0x225>
  40211b:	80 7c 24 30 00       	cmpb   $0x0,0x30(%rsp)
  402120:	74 81                	je     4020a3 <__intel_new_feature_proc_init_n+0xe3>
  402122:	48 85 db             	test   %rbx,%rbx
  402125:	0f 84 b2 00 00 00    	je     4021dd <__intel_new_feature_proc_init_n+0x21d>
  40212b:	4d 89 ec             	mov    %r13,%r12
  40212e:	48 89 df             	mov    %rbx,%rdi
  402131:	e8 ca ef ff ff       	call   401100 <strlen@plt>
  402136:	49 89 c5             	mov    %rax,%r13
  402139:	48 8d 3d 96 6f 00 00 	lea    0x6f96(%rip),%rdi        # 4090d6 <_IO_stdin_used+0xd6>
  402140:	e8 bb ef ff ff       	call   401100 <strlen@plt>
  402145:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
  40214a:	48 89 5c 24 08       	mov    %rbx,0x8(%rsp)
  40214f:	49 63 df             	movslq %r15d,%rbx
  402152:	48 8b 3c 24          	mov    (%rsp),%rdi
  402156:	e8 a5 ef ff ff       	call   401100 <strlen@plt>
  40215b:	49 89 c7             	mov    %rax,%r15
  40215e:	4c 89 f7             	mov    %r14,%rdi
  402161:	e8 9a ef ff ff       	call   401100 <strlen@plt>
  402166:	49 01 dd             	add    %rbx,%r13
  402169:	4c 03 6c 24 28       	add    0x28(%rsp),%r13
  40216e:	4c 01 f8             	add    %r15,%rax
  402171:	4c 01 e8             	add    %r13,%rax
  402174:	b9 ff 03 00 00       	mov    $0x3ff,%ecx
  402179:	29 d9                	sub    %ebx,%ecx
  40217b:	48 63 d1             	movslq %ecx,%rdx
  40217e:	48 3d ff 03 00 00    	cmp    $0x3ff,%rax
  402184:	0f 87 dd 00 00 00    	ja     402267 <__intel_new_feature_proc_init_n+0x2a7>
  40218a:	b9 00 04 00 00       	mov    $0x400,%ecx
  40218f:	4d 89 e5             	mov    %r12,%r13
  402192:	4c 89 e7             	mov    %r12,%rdi
  402195:	48 8d 35 3a 6f 00 00 	lea    0x6f3a(%rip),%rsi        # 4090d6 <_IO_stdin_used+0xd6>
  40219c:	e8 4f f0 ff ff       	call   4011f0 <__strncat_chk@plt>
  4021a1:	4c 89 e7             	mov    %r12,%rdi
  4021a4:	e8 57 ef ff ff       	call   401100 <strlen@plt>
  4021a9:	48 c1 e0 20          	shl    $0x20,%rax
  4021ad:	48 ba 00 00 00 00 ff 	movabs $0x3ff00000000,%rdx
  4021b4:	03 00 00 
  4021b7:	48 29 c2             	sub    %rax,%rdx
  4021ba:	48 c1 fa 20          	sar    $0x20,%rdx
  4021be:	b9 00 04 00 00       	mov    $0x400,%ecx
  4021c3:	4c 89 e7             	mov    %r12,%rdi
  4021c6:	48 8b 74 24 08       	mov    0x8(%rsp),%rsi
  4021cb:	e8 20 f0 ff ff       	call   4011f0 <__strncat_chk@plt>
  4021d0:	4c 89 f3             	mov    %r14,%rbx
  4021d3:	4c 8d 64 24 10       	lea    0x10(%rsp),%r12
  4021d8:	e9 e1 fe ff ff       	jmp    4020be <__intel_new_feature_proc_init_n+0xfe>
  4021dd:	4c 89 f3             	mov    %r14,%rbx
  4021e0:	e9 e4 fe ff ff       	jmp    4020c9 <__intel_new_feature_proc_init_n+0x109>
  4021e5:	bf 01 00 00 00       	mov    $0x1,%edi
  4021ea:	31 f6                	xor    %esi,%esi
  4021ec:	31 d2                	xor    %edx,%edx
  4021ee:	31 c0                	xor    %eax,%eax
  4021f0:	e8 bb 5f 00 00       	call   4081b0 <__libirc_print>
  4021f5:	e9 ce 00 00 00       	jmp    4022c8 <__intel_new_feature_proc_init_n+0x308>
  4021fa:	48 85 db             	test   %rbx,%rbx
  4021fd:	0f 84 ac 00 00 00    	je     4022af <__intel_new_feature_proc_init_n+0x2ef>
  402203:	49 89 dc             	mov    %rbx,%r12
  402206:	b8 ff 03 00 00       	mov    $0x3ff,%eax
  40220b:	44 29 f8             	sub    %r15d,%eax
  40220e:	48 63 d0             	movslq %eax,%rdx
  402211:	eb 59                	jmp    40226c <__intel_new_feature_proc_init_n+0x2ac>
  402213:	bf 01 00 00 00       	mov    $0x1,%edi
  402218:	31 f6                	xor    %esi,%esi
  40221a:	31 d2                	xor    %edx,%edx
  40221c:	31 c0                	xor    %eax,%eax
  40221e:	e8 8d 5f 00 00       	call   4081b0 <__libirc_print>
  402223:	bf 01 00 00 00       	mov    $0x1,%edi
  402228:	be 3b 00 00 00       	mov    $0x3b,%esi
  40222d:	31 d2                	xor    %edx,%edx
  40222f:	31 c0                	xor    %eax,%eax
  402231:	e8 7a 5f 00 00       	call   4081b0 <__libirc_print>
  402236:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  40223d:	00 00 
  40223f:	48 3b 84 24 30 04 00 	cmp    0x430(%rsp),%rax
  402246:	00 
  402247:	0f 85 d8 00 00 00    	jne    402325 <__intel_new_feature_proc_init_n+0x365>
  40224d:	bf 01 00 00 00       	mov    $0x1,%edi
  402252:	31 f6                	xor    %esi,%esi
  402254:	31 d2                	xor    %edx,%edx
  402256:	31 c0                	xor    %eax,%eax
  402258:	e8 53 5f 00 00       	call   4081b0 <__libirc_print>
  40225d:	bf 01 00 00 00       	mov    $0x1,%edi
  402262:	e8 f9 ed ff ff       	call   401060 <exit@plt>
  402267:	4c 8b 64 24 08       	mov    0x8(%rsp),%r12
  40226c:	4c 8d 74 24 30       	lea    0x30(%rsp),%r14
  402271:	b9 00 04 00 00       	mov    $0x400,%ecx
  402276:	4c 89 f7             	mov    %r14,%rdi
  402279:	48 8b 34 24          	mov    (%rsp),%rsi
  40227d:	e8 6e ef ff ff       	call   4011f0 <__strncat_chk@plt>
  402282:	4c 89 f7             	mov    %r14,%rdi
  402285:	e8 76 ee ff ff       	call   401100 <strlen@plt>
  40228a:	48 c1 e0 20          	shl    $0x20,%rax
  40228e:	48 ba 00 00 00 00 ff 	movabs $0x3ff00000000,%rdx
  402295:	03 00 00 
  402298:	48 29 c2             	sub    %rax,%rdx
  40229b:	48 c1 fa 20          	sar    $0x20,%rdx
  40229f:	b9 00 04 00 00       	mov    $0x400,%ecx
  4022a4:	4c 89 f7             	mov    %r14,%rdi
  4022a7:	4c 89 e6             	mov    %r12,%rsi
  4022aa:	e8 41 ef ff ff       	call   4011f0 <__strncat_chk@plt>
  4022af:	0f b6 5c 24 30       	movzbl 0x30(%rsp),%ebx
  4022b4:	bf 01 00 00 00       	mov    $0x1,%edi
  4022b9:	31 f6                	xor    %esi,%esi
  4022bb:	31 d2                	xor    %edx,%edx
  4022bd:	31 c0                	xor    %eax,%eax
  4022bf:	e8 ec 5e 00 00       	call   4081b0 <__libirc_print>
  4022c4:	84 db                	test   %bl,%bl
  4022c6:	75 15                	jne    4022dd <__intel_new_feature_proc_init_n+0x31d>
  4022c8:	bf 01 00 00 00       	mov    $0x1,%edi
  4022cd:	be 3a 00 00 00       	mov    $0x3a,%esi
  4022d2:	31 d2                	xor    %edx,%edx
  4022d4:	31 c0                	xor    %eax,%eax
  4022d6:	e8 d5 5e 00 00       	call   4081b0 <__libirc_print>
  4022db:	eb 1b                	jmp    4022f8 <__intel_new_feature_proc_init_n+0x338>
  4022dd:	48 8d 4c 24 30       	lea    0x30(%rsp),%rcx
  4022e2:	bf 01 00 00 00       	mov    $0x1,%edi
  4022e7:	be 38 00 00 00       	mov    $0x38,%esi
  ...
  4022ff:	31 d2                	xor    %edx,%edx
  402301:	31 c0                	xor    %eax,%eax
  402303:	e8 a8 5e 00 00       	call   4081b0 <__libirc_print>
  402308:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  40230f:	00 00 
  402311:	48 3b 84 24 30 04 00 	cmp    0x430(%rsp),%rax
  402318:	00 
  402319:	75 0a                	jne    402325 <__intel_new_feature_proc_init_n+0x365>
  40231b:	bf 01 00 00 00       	mov    $0x1,%edi
  402320:	e8 3b ed ff ff       	call   401060 <exit@plt>
  402325:	e8 56 ee ff ff       	call   401180 <__stack_chk_fail@plt>
  40232a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)

0000000000402330 <__intel_new_feature_proc_init>:
  402330:	f3 0f 1e fa          	endbr64
  402334:	53                   	push   %rbx
  402335:	89 fb                	mov    %edi,%ebx
  402337:	31 ff                	xor    %edi,%edi
  402339:	e8 82 fc ff ff       	call   401fc0 <__intel_new_feature_proc_init_n>
  40233e:	48 c7 c7 a0 c2 40 00 	mov    $0x40c2a0,%rdi
  402345:	be 06 00 00 00       	mov    $0x6,%esi
  40234a:	e8 e1 52 00 00       	call   407630 <__libirc_get_cpu_feature>
  40234f:	83 f8 01             	cmp    $0x1,%eax
  402352:	75 0a                	jne    40235e <__intel_new_feature_proc_init+0x2e>
  402354:	31 ff                	xor    %edi,%edi
  402356:	89 de                	mov    %ebx,%esi
  402358:	5b                   	pop    %rbx
  402359:	e9 52 00 00 00       	jmp    4023b0 <__intel_proc_init_ftzdazule>
  40235e:	85 c0                	test   %eax,%eax
  402360:	78 02                	js     402364 <__intel_new_feature_proc_init+0x34>
  402362:	5b                   	pop    %rbx
  402363:	c3                   	ret
  402364:	bf 01 00 00 00       	mov    $0x1,%edi
  402369:	31 f6                	xor    %esi,%esi
  40236b:	31 d2                	xor    %edx,%edx
  40236d:	31 c0                	xor    %eax,%eax
  40236f:	e8 3c 5e 00 00       	call   4081b0 <__libirc_print>
  402374:	bf 01 00 00 00       	mov    $0x1,%edi
  402379:	be 3a 00 00 00       	mov    $0x3a,%esi
  ...
  40238c:	31 f6                	xor    %esi,%esi
  40238e:	31 d2                	xor    %edx,%edx
  402390:	31 c0                	xor    %eax,%eax
  402392:	e8 19 5e 00 00       	call   4081b0 <__libirc_print>
  402397:	bf 01 00 00 00       	mov    $0x1,%edi
  40239c:	e8 bf ec ff ff       	call   401060 <exit@plt>
  4023a1:	0f 1f 00             	nopl   (%rax)
  4023a4:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  4023ab:	00 00 00 
  4023ae:	66 90                	xchg   %ax,%ax

00000000004023b0 <__intel_proc_init_ftzdazule>:
  4023b0:	f3 0f 1e fa          	endbr64
  4023b4:	55                   	push   %rbp
  4023b5:	41 56                	push   %r14
  4023b7:	53                   	push   %rbx
  4023b8:	48 81 ec 20 02 00 00 	sub    $0x220,%rsp
  4023bf:	89 f3                	mov    %esi,%ebx
  4023c1:	41 89 f6             	mov    %esi,%r14d
  4023c4:	41 83 e6 04          	and    $0x4,%r14d
  4023c8:	89 f5                	mov    %esi,%ebp
  4023ca:	83 e5 02             	and    $0x2,%ebp
  4023cd:	74 07                	je     4023d6 <__intel_proc_init_ftzdazule+0x26>
  4023cf:	89 f8                	mov    %edi,%eax
  4023d1:	83 e0 02             	and    $0x2,%eax
  4023d4:	74 12                	je     4023e8 <__intel_proc_init_ftzdazule+0x38>
  4023d6:	31 c0                	xor    %eax,%eax
  4023d8:	45 85 f6             	test   %r14d,%r14d
  4023db:	74 38                	je     402415 <__intel_proc_init_ftzdazule+0x65>
  4023dd:	b8 01 00 00 00       	mov    $0x1,%eax
  4023e2:	40 f6 c7 04          	test   $0x4,%dil
  4023e6:	75 2d                	jne    402415 <__intel_proc_init_ftzdazule+0x65>
  4023e8:	48 8d 7c 24 20       	lea    0x20(%rsp),%rdi
  4023ed:	ba 00 02 00 00       	mov    $0x200,%edx
  4023f2:	31 f6                	xor    %esi,%esi
  4023f4:	e8 07 ee ff ff       	call   401200 <memset@plt>
  4023f9:	0f ae 44 24 20       	fxsave 0x20(%rsp)
  4023fe:	8b 44 24 3c          	mov    0x3c(%rsp),%eax
  402402:	89 c1                	mov    %eax,%ecx
  402404:	c1 e1 19             	shl    $0x19,%ecx
  402407:	c1 f9 1f             	sar    $0x1f,%ecx
  40240a:	21 cd                	and    %ecx,%ebp
  40240c:	c1 e0 0e             	shl    $0xe,%eax
  40240f:	c1 f8 1f             	sar    $0x1f,%eax
  402412:	44 21 f0             	and    %r14d,%eax
  402415:	f6 c3 01             	test   $0x1,%bl
  402418:	74 17                	je     402431 <__intel_proc_init_ftzdazule+0x81>
  40241a:	0f ae 5c 24 1c       	stmxcsr 0x1c(%rsp)
  40241f:	b9 00 80 00 00       	mov    $0x8000,%ecx
  402424:	0b 4c 24 1c          	or     0x1c(%rsp),%ecx
  402428:	89 4c 24 18          	mov    %ecx,0x18(%rsp)
  40242c:	0f ae 54 24 18       	ldmxcsr 0x18(%rsp)
  402431:	85 ed                	test   %ebp,%ebp
  402433:	74 15                	je     40244a <__intel_proc_init_ftzdazule+0x9a>
  402435:	0f ae 5c 24 14       	stmxcsr 0x14(%rsp)
  40243a:	8b 4c 24 14          	mov    0x14(%rsp),%ecx
  40243e:	83 c9 40             	or     $0x40,%ecx
  402441:	89 4c 24 10          	mov    %ecx,0x10(%rsp)
  402445:	0f ae 54 24 10       	ldmxcsr 0x10(%rsp)
  40244a:	85 c0                	test   %eax,%eax
  40244c:	74 17                	je     402465 <__intel_proc_init_ftzdazule+0xb5>
  40244e:	0f ae 5c 24 0c       	stmxcsr 0xc(%rsp)
  402453:	b8 00 00 02 00       	mov    $0x20000,%eax
  402458:	0b 44 24 0c          	or     0xc(%rsp),%eax
  40245c:	89 44 24 08          	mov    %eax,0x8(%rsp)
  402460:	0f ae 54 24 08       	ldmxcsr 0x8(%rsp)
  402465:	48 81 c4 20 02 00 00 	add    $0x220,%rsp
  40246c:	5b                   	pop    %rbx
  40246d:	41 5e                	pop    %r14
  40246f:	5d                   	pop    %rbp
  402470:	c3                   	ret
  402471:	0f 1f 00             	nopl   (%rax)
  402474:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  40247b:	00 00 00 

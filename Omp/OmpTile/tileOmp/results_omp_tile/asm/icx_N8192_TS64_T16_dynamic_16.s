...
results_omp_tile/bin/icx_N8192_TS64_T16_dynamic_16:     file format elf64-x86-64
...
0000000000401610 <main>:
  ...
  40162a:	e8 31 0e 00 00       	call   402460 <__intel_new_feature_proc_init>
  ...
  401745:	48 c7 44 24 30 ff 3f 	movq   $0x3fff,0x30(%rsp)
  40174c:	00 00 
...
0000000000401aa0 <main.extracted.18>:
  ...
  401ad1:	00 00 
  401ad3:	48 c7 44 24 18 ff 3f 	movq   $0x3fff,0x18(%rsp)
  401ada:	00 00 
  ...
  401af2:	41 b8 ff 3f 00 00    	mov    $0x3fff,%r8d
  ...
  401b57:	0f 84 60 03 00 00    	je     401ebd <main.extracted.18+0x41d>
  401b5d:	48 8b 54 24 20       	mov    0x20(%rsp),%rdx
  401b62:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
  401b67:	48 39 c2             	cmp    %rax,%rdx
  401b6a:	0f 87 4d 03 00 00    	ja     401ebd <main.extracted.18+0x41d>
  ...
  401b9c:	00 00 00 00 
  401ba0:	48 8b 4c 24 58       	mov    0x58(%rsp),%rcx
  401ba5:	48 3b 4c 24 48       	cmp    0x48(%rsp),%rcx
  ...
  401bbf:	48 89 4c 24 58       	mov    %rcx,0x58(%rsp)
  401bc4:	48 8d 54 0a 7f       	lea    0x7f(%rdx,%rcx,1),%rdx
  401bc9:	48 0f 49 d0          	cmovns %rax,%rdx
  401bcd:	48 c1 ea 07          	shr    $0x7,%rdx
  401bd1:	89 d1                	mov    %edx,%ecx
  401bd3:	c1 e1 07             	shl    $0x7,%ecx
  401bd6:	29 c8                	sub    %ecx,%eax
  401bd8:	89 d6                	mov    %edx,%esi
  401bda:	c1 e6 06             	shl    $0x6,%esi
  401bdd:	83 fa 7f             	cmp    $0x7f,%edx
  401be0:	b9 7f 00 00 00       	mov    $0x7f,%ecx
  401be5:	0f 4d d1             	cmovge %ecx,%edx
  401be8:	c1 e2 06             	shl    $0x6,%edx
  401beb:	83 c2 40             	add    $0x40,%edx
  401bee:	48 89 54 24 78       	mov    %rdx,0x78(%rsp)
  401bf3:	81 fe c0 1f 00 00    	cmp    $0x1fc0,%esi
  401bf9:	b9 c0 1f 00 00       	mov    $0x1fc0,%ecx
  401bfe:	0f 4c ce             	cmovl  %esi,%ecx
  401c01:	29 f1                	sub    %esi,%ecx
  401c03:	83 c9 3f             	or     $0x3f,%ecx
  401c06:	48 89 8c 24 80 00 00 	mov    %rcx,0x80(%rsp)
  401c0d:	00 
  401c0e:	c1 e0 06             	shl    $0x6,%eax
  401c11:	48 98                	cltq
  401c13:	89 74 24 2c          	mov    %esi,0x2c(%rsp)
  401c17:	48 63 ce             	movslq %esi,%rcx
  401c1a:	49 89 ca             	mov    %rcx,%r10
  401c1d:	49 c1 e2 0d          	shl    $0xd,%r10
  401c21:	49 01 c2             	add    %rax,%r10
  401c24:	48 8d 04 c5 c0 01 00 	lea    0x1c0(,%rax,8),%rax
  401c2b:	00 
  401c2c:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
  401c31:	48 c1 e1 10          	shl    $0x10,%rcx
  401c35:	48 89 4c 24 38       	mov    %rcx,0x38(%rsp)
  401c3a:	48 c7 44 24 10 00 00 	movq   $0x0,0x10(%rsp)
  401c41:	00 00 
  401c43:	eb 33                	jmp    401c78 <main.extracted.18+0x1d8>
  401c45:	66 66 2e 0f 1f 84 00 	data16 cs nopw 0x0(%rax,%rax,1)
  401c4c:	00 00 00 00 
  401c50:	48 8b 4c 24 10       	mov    0x10(%rsp),%rcx
  401c55:	8d 41 01             	lea    0x1(%rcx),%eax
  401c58:	48 81 44 24 30 00 00 	addq   $0x400000,0x30(%rsp)
  401c5f:	40 00 
  401c61:	48 81 44 24 38 00 02 	addq   $0x200,0x38(%rsp)
  401c68:	00 00 
  401c6a:	83 f9 7f             	cmp    $0x7f,%ecx
  401c6d:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
  401c72:	0f 84 28 ff ff ff    	je     401ba0 <main.extracted.18+0x100>
  401c78:	48 8b 44 24 78       	mov    0x78(%rsp),%rax
  401c7d:	39 44 24 2c          	cmp    %eax,0x2c(%rsp)
  401c81:	7d cd                	jge    401c50 <main.extracted.18+0x1b0>
  401c83:	48 8b 44 24 10       	mov    0x10(%rsp),%rax
  401c88:	c1 e0 06             	shl    $0x6,%eax
  401c8b:	8d 48 40             	lea    0x40(%rax),%ecx
  401c8e:	31 d2                	xor    %edx,%edx
  401c90:	81 f9 00 20 00 00    	cmp    $0x2000,%ecx
  401c96:	0f 9c c2             	setl   %dl
  401c99:	31 c9                	xor    %ecx,%ecx
  401c9b:	3d 00 20 00 00       	cmp    $0x2000,%eax
  401ca0:	0f 9c c1             	setl   %cl
  401ca3:	38 d1                	cmp    %dl,%cl
  401ca5:	0f 47 d1             	cmova  %ecx,%edx
  401ca8:	80 fa 01             	cmp    $0x1,%dl
  401cab:	75 a3                	jne    401c50 <main.extracted.18+0x1b0>
  401cad:	48 8b 44 24 70       	mov    0x70(%rsp),%rax
  401cb2:	48 8b 28             	mov    (%rax),%rbp
  401cb5:	48 8b 44 24 68       	mov    0x68(%rsp),%rax
  401cba:	4c 8b 18             	mov    (%rax),%r11
  401cbd:	4c 03 5c 24 30       	add    0x30(%rsp),%r11
  401cc2:	48 8b 44 24 60       	mov    0x60(%rsp),%rax
  401cc7:	48 8b 08             	mov    (%rax),%rcx
  401cca:	48 03 4c 24 38       	add    0x38(%rsp),%rcx
  401ccf:	31 c0                	xor    %eax,%eax
  401cd1:	66 66 66 66 66 66 2e 	data16 data16 data16 data16 data16 cs nopw 0x0(%rax,%rax,1)
  401cd8:	0f 1f 84 00 00 00 00 
  401cdf:	00 
  401ce0:	49 89 c0             	mov    %rax,%r8
  401ce3:	49 c1 e0 0d          	shl    $0xd,%r8
  401ce7:	4b 8d 1c 02          	lea    (%r10,%r8,1),%rbx
  401ceb:	4f 8d 74 10 08       	lea    0x8(%r8,%r10,1),%r14
  401cf0:	4f 8d 7c 10 10       	lea    0x10(%r8,%r10,1),%r15
  401cf5:	4b 8d 54 10 18       	lea    0x18(%r8,%r10,1),%rdx
  401cfa:	4b 8d 7c 10 20       	lea    0x20(%r8,%r10,1),%rdi
  401cff:	4b 8d 74 10 28       	lea    0x28(%r8,%r10,1),%rsi
  401d04:	4f 8d 6c 10 30       	lea    0x30(%r8,%r10,1),%r13
  401d09:	4f 8d 4c 10 38       	lea    0x38(%r8,%r10,1),%r9
  401d0e:	4d 89 dc             	mov    %r11,%r12
  401d11:	45 31 c0             	xor    %r8d,%r8d
  401d14:	66 66 66 2e 0f 1f 84 	data16 data16 cs nopw 0x0(%rax,%rax,1)
  401d1b:	00 00 00 00 00 
  401d20:	c4 c1 7d 10 8c 24 40 	vmovupd -0x1c0(%r12),%ymm1
  401d27:	fe ff ff 
  401d2a:	c4 c1 7d 10 94 24 60 	vmovupd -0x1a0(%r12),%ymm2
  401d31:	fe ff ff 
  401d34:	c4 a2 7d 19 04 c1    	vbroadcastsd (%rcx,%r8,8),%ymm0
  401d3a:	c4 e2 fd a8 54 dd 20 	vfmadd213pd 0x20(%rbp,%rbx,8),%ymm0,%ymm2
  401d41:	c4 e2 fd a8 4c dd 00 	vfmadd213pd 0x0(%rbp,%rbx,8),%ymm0,%ymm1
  401d48:	c5 fd 11 4c dd 00    	vmovupd %ymm1,0x0(%rbp,%rbx,8)
  401d4e:	c5 fd 11 54 dd 20    	vmovupd %ymm2,0x20(%rbp,%rbx,8)
  401d54:	c4 c1 7d 10 8c 24 80 	vmovupd -0x180(%r12),%ymm1
  401d5b:	fe ff ff 
  401d5e:	c4 c1 7d 10 94 24 a0 	vmovupd -0x160(%r12),%ymm2
  401d65:	fe ff ff 
  401d68:	c4 a2 fd a8 54 f5 20 	vfmadd213pd 0x20(%rbp,%r14,8),%ymm0,%ymm2
  401d6f:	c4 a2 fd a8 4c f5 00 	vfmadd213pd 0x0(%rbp,%r14,8),%ymm0,%ymm1
  401d76:	c4 a1 7d 11 4c f5 00 	vmovupd %ymm1,0x0(%rbp,%r14,8)
  401d7d:	c4 a1 7d 11 54 f5 20 	vmovupd %ymm2,0x20(%rbp,%r14,8)
  401d84:	c4 c1 7d 10 8c 24 c0 	vmovupd -0x140(%r12),%ymm1
  401d8b:	fe ff ff 
  401d8e:	c4 c1 7d 10 94 24 e0 	vmovupd -0x120(%r12),%ymm2
  401d95:	fe ff ff 
  401d98:	c4 a2 fd a8 54 fd 20 	vfmadd213pd 0x20(%rbp,%r15,8),%ymm0,%ymm2
  401d9f:	c4 a2 fd a8 4c fd 00 	vfmadd213pd 0x0(%rbp,%r15,8),%ymm0,%ymm1
  401da6:	c4 a1 7d 11 4c fd 00 	vmovupd %ymm1,0x0(%rbp,%r15,8)
  401dad:	c4 a1 7d 11 54 fd 20 	vmovupd %ymm2,0x20(%rbp,%r15,8)
  401db4:	c4 c1 7d 10 8c 24 00 	vmovupd -0x100(%r12),%ymm1
  401dbb:	ff ff ff 
  401dbe:	c4 c1 7d 10 94 24 20 	vmovupd -0xe0(%r12),%ymm2
  401dc5:	ff ff ff 
  401dc8:	c4 e2 fd a8 54 d5 20 	vfmadd213pd 0x20(%rbp,%rdx,8),%ymm0,%ymm2
  401dcf:	c4 e2 fd a8 4c d5 00 	vfmadd213pd 0x0(%rbp,%rdx,8),%ymm0,%ymm1
  401dd6:	c5 fd 11 4c d5 00    	vmovupd %ymm1,0x0(%rbp,%rdx,8)
  401ddc:	c5 fd 11 54 d5 20    	vmovupd %ymm2,0x20(%rbp,%rdx,8)
  401de2:	c4 c1 7d 10 8c 24 40 	vmovupd -0xc0(%r12),%ymm1
  401de9:	ff ff ff 
  401dec:	c4 c1 7d 10 94 24 60 	vmovupd -0xa0(%r12),%ymm2
  401df3:	ff ff ff 
  401df6:	c4 e2 fd a8 54 fd 20 	vfmadd213pd 0x20(%rbp,%rdi,8),%ymm0,%ymm2
  401dfd:	c4 e2 fd a8 4c fd 00 	vfmadd213pd 0x0(%rbp,%rdi,8),%ymm0,%ymm1
  401e04:	c5 fd 11 4c fd 00    	vmovupd %ymm1,0x0(%rbp,%rdi,8)
  401e0a:	c5 fd 11 54 fd 20    	vmovupd %ymm2,0x20(%rbp,%rdi,8)
  401e10:	c4 c1 7d 10 4c 24 80 	vmovupd -0x80(%r12),%ymm1
  401e17:	c4 c1 7d 10 54 24 a0 	vmovupd -0x60(%r12),%ymm2
  401e1e:	c4 e2 fd a8 54 f5 20 	vfmadd213pd 0x20(%rbp,%rsi,8),%ymm0,%ymm2
  401e25:	c4 e2 fd a8 4c f5 00 	vfmadd213pd 0x0(%rbp,%rsi,8),%ymm0,%ymm1
  401e2c:	c5 fd 11 4c f5 00    	vmovupd %ymm1,0x0(%rbp,%rsi,8)
  401e32:	c5 fd 11 54 f5 20    	vmovupd %ymm2,0x20(%rbp,%rsi,8)
  401e38:	c4 c1 7d 10 4c 24 c0 	vmovupd -0x40(%r12),%ymm1
  401e3f:	c4 c1 7d 10 54 24 e0 	vmovupd -0x20(%r12),%ymm2
  401e46:	c4 a2 fd a8 54 ed 20 	vfmadd213pd 0x20(%rbp,%r13,8),%ymm0,%ymm2
  401e4d:	c4 a2 fd a8 4c ed 00 	vfmadd213pd 0x0(%rbp,%r13,8),%ymm0,%ymm1
  401e54:	c4 a1 7d 11 4c ed 00 	vmovupd %ymm1,0x0(%rbp,%r13,8)
  401e5b:	c4 a1 7d 11 54 ed 20 	vmovupd %ymm2,0x20(%rbp,%r13,8)
  401e62:	c4 c1 7d 10 0c 24    	vmovupd (%r12),%ymm1
  401e68:	c4 c1 7d 10 54 24 20 	vmovupd 0x20(%r12),%ymm2
  401e6f:	c4 a2 fd a8 54 cd 20 	vfmadd213pd 0x20(%rbp,%r9,8),%ymm0,%ymm2
  401e76:	c4 a2 fd a8 4c cd 00 	vfmadd213pd 0x0(%rbp,%r9,8),%ymm0,%ymm1
  401e7d:	c4 a1 7d 11 4c cd 00 	vmovupd %ymm1,0x0(%rbp,%r9,8)
  401e84:	c4 a1 7d 11 54 cd 20 	vmovupd %ymm2,0x20(%rbp,%r9,8)
  401e8b:	49 ff c0             	inc    %r8
  401e8e:	49 81 c4 00 00 01 00 	add    $0x10000,%r12
  401e95:	49 83 f8 40          	cmp    $0x40,%r8
  401e99:	0f 85 81 fe ff ff    	jne    401d20 <main.extracted.18+0x280>
  401e9f:	48 81 c1 00 00 01 00 	add    $0x10000,%rcx
  401ea6:	48 3b 84 24 80 00 00 	cmp    0x80(%rsp),%rax
  401ead:	00 
  401eae:	48 8d 40 01          	lea    0x1(%rax),%rax
  401eb2:	0f 85 28 fe ff ff    	jne    401ce0 <main.extracted.18+0x240>
  401eb8:	e9 93 fd ff ff       	jmp    401c50 <main.extracted.18+0x1b0>
  401ebd:	48 81 c4 88 00 00 00 	add    $0x88,%rsp
  401ec4:	5b                   	pop    %rbx
  401ec5:	41 5c                	pop    %r12
  401ec7:	41 5d                	pop    %r13
  401ec9:	41 5e                	pop    %r14
  401ecb:	41 5f                	pop    %r15
  401ecd:	5d                   	pop    %rbp
  401ece:	c3                   	ret
  401ecf:	90                   	nop
...
0000000000401ed0 <main.extracted.25>:
  ...
  401ef7:	00 
  401ef8:	c7 04 24 ff 1f 00 00 	movl   $0x1fff,(%rsp)
  ...
  401f42:	0f 87 ad 00 00 00    	ja     401ff5 <main.extracted.25+0x125>
  ...
  401f58:	75 40                	jne    401f9a <main.extracted.25+0xca>
  401f5a:	48 c1 e0 0d          	shl    $0xd,%rax
  401f5e:	48 c1 e1 0d          	shl    $0xd,%rcx
  401f62:	48 81 c1 00 20 00 00 	add    $0x2000,%rcx
  401f69:	48 ba 00 00 00 00 00 	movabs $0x4000000000000000,%rdx
  401f70:	00 00 40 
  401f73:	48 be 00 00 00 00 00 	movabs $0x4008000000000000,%rsi
  401f7a:	00 08 40 
  401f7d:	0f 1f 00             	nopl   (%rax)
  401f80:	49 89 14 c4          	mov    %rdx,(%r12,%rax,8)
  401f84:	49 89 34 c7          	mov    %rsi,(%r15,%rax,8)
  401f88:	48 c7 04 c7 00 00 00 	movq   $0x0,(%rdi,%rax,8)
  401f8f:	00 
  401f90:	48 ff c0             	inc    %rax
  401f93:	48 39 c1             	cmp    %rax,%rcx
  401f96:	75 e8                	jne    401f80 <main.extracted.25+0xb0>
  401f98:	eb 5b                	jmp    401ff5 <main.extracted.25+0x125>
  401f9a:	48 29 c2             	sub    %rax,%rdx
  401f9d:	49 89 d6             	mov    %rdx,%r14
  401fa0:	49 c1 e6 0d          	shl    $0xd,%r14
  401fa4:	48 c1 e0 10          	shl    $0x10,%rax
  401fa8:	48 01 c7             	add    %rax,%rdi
  401fab:	48 c1 e2 10          	shl    $0x10,%rdx
  401faf:	31 f6                	xor    %esi,%esi
  401fb1:	49 89 c5             	mov    %rax,%r13
  401fb4:	e8 87 00 00 00       	call   402040 <_intel_fast_memset>
  401fb9:	31 c0                	xor    %eax,%eax
  401fbb:	4d 01 ef             	add    %r13,%r15
  401fbe:	4d 01 ec             	add    %r13,%r12
  401fc1:	c4 e2 7d 19 05 7e 70 	vbroadcastsd 0x707e(%rip),%ymm0        # 409048 <_IO_stdin_used+0x48>
  401fc8:	00 00 
  401fca:	c4 e2 7d 19 0d 7d 70 	vbroadcastsd 0x707d(%rip),%ymm1        # 409050 <_IO_stdin_used+0x50>
  401fd1:	00 00 
  401fd3:	66 66 66 66 2e 0f 1f 	data16 data16 data16 cs nopw 0x0(%rax,%rax,1)
  401fda:	84 00 00 00 00 00 
  401fe0:	c4 c1 7c 11 04 c4    	vmovups %ymm0,(%r12,%rax,8)
  401fe6:	c4 c1 7c 11 0c c7    	vmovups %ymm1,(%r15,%rax,8)
  401fec:	48 83 c0 04          	add    $0x4,%rax
  401ff0:	4c 39 f0             	cmp    %r14,%rax
  401ff3:	7c eb                	jl     401fe0 <main.extracted.25+0x110>
  401ff5:	bf 00 c2 40 00       	mov    $0x40c200,%edi
  401ffa:	89 de                	mov    %ebx,%esi
  401ffc:	48 83 c4 10          	add    $0x10,%rsp
  402000:	5b                   	pop    %rbx
  402001:	41 5c                	pop    %r12
  402003:	41 5d                	pop    %r13
  402005:	41 5e                	pop    %r14
  402007:	41 5f                	pop    %r15
  402009:	c5 f8 77             	vzeroupper
  40200c:	e9 7f f0 ff ff       	jmp    401090 <__kmpc_for_static_fini@plt>
  402011:	0f 1f 00             	nopl   (%rax)
  402014:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  40201b:	00 00 00 
  40201e:	66 90                	xchg   %ax,%ax

0000000000402020 <__intel_get_fast_memset_impl.V>:
  402020:	48 c7 c0 90 3e 40 00 	mov    $0x403e90,%rax
  402027:	c3                   	ret
  402028:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
  40202f:	00 

0000000000402030 <__intel_get_fast_memset_impl.Z>:
  402030:	48 c7 c0 c0 25 40 00 	mov    $0x4025c0,%rax
  402037:	c3                   	ret
  402038:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
  40203f:	00 

0000000000402040 <_intel_fast_memset>:
  402040:	f3 0f 1e fa          	endbr64
  402044:	48 8b 05 45 a2 00 00 	mov    0xa245(%rip),%rax        # 40c290 <__real_memset_impl>
  40204b:	48 85 c0             	test   %rax,%rax
  40204e:	0f 84 0c 00 00 00    	je     402060 <__real_memset_impl_setup>
  402054:	ff e0                	jmp    *%rax
  402056:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  40205d:	00 00 00 

0000000000402060 <__real_memset_impl_setup>:
  402060:	55                   	push   %rbp
  402061:	41 56                	push   %r14
  402063:	53                   	push   %rbx
  402064:	48 89 d3             	mov    %rdx,%rbx
  402067:	89 f5                	mov    %esi,%ebp
  402069:	49 89 fe             	mov    %rdi,%r14
  40206c:	48 c7 c1 b0 c2 40 00 	mov    $0x40c2b0,%rcx
  402073:	48 8b 01             	mov    (%rcx),%rax
  402076:	48 85 c0             	test   %rax,%rax
  402079:	75 12                	jne    40208d <__real_memset_impl_setup+0x2d>
  40207b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  402080:	e8 9b 4b 00 00       	call   406c20 <__intel_cpu_features_init_x>
  402085:	48 8b 01             	mov    (%rcx),%rax
  402088:	48 85 c0             	test   %rax,%rax
  40208b:	74 f3                	je     402080 <__real_memset_impl_setup+0x20>
  40208d:	48 89 c1             	mov    %rax,%rcx
  402090:	48 f7 d1             	not    %rcx
  402093:	48 ba ec 9f 9d 18 07 	movabs $0x7189d9fec,%rdx
  40209a:	00 00 00 
  40209d:	48 85 d1             	test   %rdx,%rcx
  4020a0:	75 07                	jne    4020a9 <__real_memset_impl_setup+0x49>
  4020a2:	e8 89 ff ff ff       	call   402030 <__intel_get_fast_memset_impl.Z>
  4020a7:	eb 29                	jmp    4020d2 <__real_memset_impl_setup+0x72>
  4020a9:	89 c1                	mov    %eax,%ecx
  4020ab:	f7 d1                	not    %ecx
  4020ad:	f7 c1 ec 9f 9d 00    	test   $0x9d9fec,%ecx
  4020b3:	75 07                	jne    4020bc <__real_memset_impl_setup+0x5c>
  4020b5:	e8 66 ff ff ff       	call   402020 <__intel_get_fast_memset_impl.V>
  4020ba:	eb 16                	jmp    4020d2 <__real_memset_impl_setup+0x72>
  4020bc:	f7 d0                	not    %eax
  4020be:	a8 6c                	test   $0x6c,%al
  4020c0:	75 09                	jne    4020cb <__real_memset_impl_setup+0x6b>
  4020c2:	48 c7 c0 60 4f 40 00 	mov    $0x404f60,%rax
  4020c9:	eb 07                	jmp    4020d2 <__real_memset_impl_setup+0x72>
  4020cb:	48 8b 05 de 9e 00 00 	mov    0x9ede(%rip),%rax        # 40bfb0 <memset@GLIBC_2.2.5>
  4020d2:	48 89 05 b7 a1 00 00 	mov    %rax,0xa1b7(%rip)        # 40c290 <__real_memset_impl>
  4020d9:	4c 89 f7             	mov    %r14,%rdi
  4020dc:	89 ee                	mov    %ebp,%esi
  4020de:	48 89 da             	mov    %rbx,%rdx
  4020e1:	5b                   	pop    %rbx
  4020e2:	41 5e                	pop    %r14
  4020e4:	5d                   	pop    %rbp
  4020e5:	ff e0                	jmp    *%rax
  4020e7:	90                   	nop
  4020e8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
  4020ef:	00 

00000000004020f0 <__intel_new_feature_proc_init_n>:
  4020f0:	f3 0f 1e fa          	endbr64
  4020f4:	55                   	push   %rbp
  4020f5:	41 57                	push   %r15
  4020f7:	41 56                	push   %r14
  4020f9:	41 55                	push   %r13
  4020fb:	41 54                	push   %r12
  4020fd:	53                   	push   %rbx
  4020fe:	48 81 ec 38 04 00 00 	sub    $0x438,%rsp
  402105:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  40210c:	00 00 
  40210e:	48 89 84 24 30 04 00 	mov    %rax,0x430(%rsp)
  402115:	00 
  402116:	0f 57 c0             	xorps  %xmm0,%xmm0
  402119:	0f 29 44 24 10       	movaps %xmm0,0x10(%rsp)
  40211e:	48 c7 c1 a0 c2 40 00 	mov    $0x40c2a0,%rcx
  402125:	48 83 39 00          	cmpq   $0x0,(%rcx)
  402129:	75 17                	jne    402142 <__intel_new_feature_proc_init_n+0x52>
  40212b:	e8 10 40 00 00       	call   406140 <__intel_cpu_features_init>
  402130:	85 c0                	test   %eax,%eax
  402132:	0f 85 0b 02 00 00    	jne    402343 <__intel_new_feature_proc_init_n+0x253>
  402138:	48 83 39 00          	cmpq   $0x0,(%rcx)
  40213c:	0f 84 01 02 00 00    	je     402343 <__intel_new_feature_proc_init_n+0x253>
  402142:	83 ff 02             	cmp    $0x2,%edi
  402145:	7d 38                	jge    40217f <__intel_new_feature_proc_init_n+0x8f>
  402147:	48 63 c7             	movslq %edi,%rax
  40214a:	48 8b 0c c1          	mov    (%rcx,%rax,8),%rcx
  40214e:	48 f7 d1             	not    %rcx
  402151:	48 85 ce             	test   %rcx,%rsi
  402154:	75 48                	jne    40219e <__intel_new_feature_proc_init_n+0xae>
  402156:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  40215d:	00 00 
  40215f:	48 3b 84 24 30 04 00 	cmp    0x430(%rsp),%rax
  402166:	00 
  402167:	0f 85 e8 02 00 00    	jne    402455 <__intel_new_feature_proc_init_n+0x365>
  40216d:	48 81 c4 38 04 00 00 	add    $0x438,%rsp
  402174:	5b                   	pop    %rbx
  402175:	41 5c                	pop    %r12
  402177:	41 5d                	pop    %r13
  402179:	41 5e                	pop    %r14
  40217b:	41 5f                	pop    %r15
  40217d:	5d                   	pop    %rbp
  40217e:	c3                   	ret
  40217f:	bf 01 00 00 00       	mov    $0x1,%edi
  402184:	31 f6                	xor    %esi,%esi
  402186:	31 d2                	xor    %edx,%edx
  402188:	31 c0                	xor    %eax,%eax
  40218a:	e8 61 61 00 00       	call   4082f0 <__libirc_print>
  40218f:	bf 01 00 00 00       	mov    $0x1,%edi
  402194:	be 3a 00 00 00       	mov    $0x3a,%esi
  402199:	e9 bf 01 00 00       	jmp    40235d <__intel_new_feature_proc_init_n+0x26d>
  40219e:	48 21 f1             	and    %rsi,%rcx
  4021a1:	48 89 4c c4 10       	mov    %rcx,0x10(%rsp,%rax,8)
  4021a6:	45 31 ff             	xor    %r15d,%r15d
  4021a9:	bf 39 00 00 00       	mov    $0x39,%edi
  4021ae:	31 f6                	xor    %esi,%esi
  4021b0:	31 c0                	xor    %eax,%eax
  4021b2:	e8 f9 5e 00 00       	call   4080b0 <__libirc_get_msg>
  4021b7:	48 89 04 24          	mov    %rax,(%rsp)
  4021bb:	c6 44 24 30 00       	movb   $0x0,0x30(%rsp)
  4021c0:	bd 01 00 00 00       	mov    $0x1,%ebp
  4021c5:	4c 8d 64 24 10       	lea    0x10(%rsp),%r12
  4021ca:	4c 8d 6c 24 30       	lea    0x30(%rsp),%r13
  4021cf:	31 db                	xor    %ebx,%ebx
  4021d1:	eb 31                	jmp    402204 <__intel_new_feature_proc_init_n+0x114>
  4021d3:	b8 ff 03 00 00       	mov    $0x3ff,%eax
  4021d8:	44 29 f8             	sub    %r15d,%eax
  4021db:	48 63 d0             	movslq %eax,%rdx
  4021de:	b9 00 04 00 00       	mov    $0x400,%ecx
  4021e3:	4c 89 ef             	mov    %r13,%rdi
  4021e6:	4c 89 f6             	mov    %r14,%rsi
  4021e9:	e8 02 f0 ff ff       	call   4011f0 <__strncat_chk@plt>
  4021ee:	4c 89 ef             	mov    %r13,%rdi
  4021f1:	e8 0a ef ff ff       	call   401100 <strlen@plt>
  4021f6:	49 89 c7             	mov    %rax,%r15
  4021f9:	ff c5                	inc    %ebp
  4021fb:	83 fd 47             	cmp    $0x47,%ebp
  4021fe:	0f 84 26 01 00 00    	je     40232a <__intel_new_feature_proc_init_n+0x23a>
  402204:	89 e8                	mov    %ebp,%eax
  402206:	e8 25 55 00 00       	call   407730 <__libirc_get_feature_bitpos>
  40220b:	85 c0                	test   %eax,%eax
  40220d:	78 ea                	js     4021f9 <__intel_new_feature_proc_init_n+0x109>
  40220f:	4c 89 e7             	mov    %r12,%rdi
  402212:	89 ee                	mov    %ebp,%esi
  402214:	e8 57 55 00 00       	call   407770 <__libirc_get_cpu_feature>
  402219:	85 c0                	test   %eax,%eax
  40221b:	74 dc                	je     4021f9 <__intel_new_feature_proc_init_n+0x109>
  40221d:	4c 89 e7             	mov    %r12,%rdi
  402220:	89 ee                	mov    %ebp,%esi
  402222:	e8 49 55 00 00       	call   407770 <__libirc_get_cpu_feature>
  402227:	85 c0                	test   %eax,%eax
  402229:	0f 88 e6 00 00 00    	js     402315 <__intel_new_feature_proc_init_n+0x225>
  40222f:	89 ef                	mov    %ebp,%edi
  402231:	e8 0a 4a 00 00       	call   406c40 <__libirc_get_feature_name>
  402236:	48 85 c0             	test   %rax,%rax
  402239:	0f 84 d6 00 00 00    	je     402315 <__intel_new_feature_proc_init_n+0x225>
  40223f:	49 89 c6             	mov    %rax,%r14
  402242:	80 38 00             	cmpb   $0x0,(%rax)
  402245:	0f 84 ca 00 00 00    	je     402315 <__intel_new_feature_proc_init_n+0x225>
  40224b:	80 7c 24 30 00       	cmpb   $0x0,0x30(%rsp)
  402250:	74 81                	je     4021d3 <__intel_new_feature_proc_init_n+0xe3>
  402252:	48 85 db             	test   %rbx,%rbx
  402255:	0f 84 b2 00 00 00    	je     40230d <__intel_new_feature_proc_init_n+0x21d>
  40225b:	4d 89 ec             	mov    %r13,%r12
  40225e:	48 89 df             	mov    %rbx,%rdi
  402261:	e8 9a ee ff ff       	call   401100 <strlen@plt>
  402266:	49 89 c5             	mov    %rax,%r13
  402269:	48 8d 3d 66 6e 00 00 	lea    0x6e66(%rip),%rdi        # 4090d6 <_IO_stdin_used+0xd6>
  402270:	e8 8b ee ff ff       	call   401100 <strlen@plt>
  402275:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
  40227a:	48 89 5c 24 08       	mov    %rbx,0x8(%rsp)
  40227f:	49 63 df             	movslq %r15d,%rbx
  402282:	48 8b 3c 24          	mov    (%rsp),%rdi
  402286:	e8 75 ee ff ff       	call   401100 <strlen@plt>
  40228b:	49 89 c7             	mov    %rax,%r15
  40228e:	4c 89 f7             	mov    %r14,%rdi
  402291:	e8 6a ee ff ff       	call   401100 <strlen@plt>
  402296:	49 01 dd             	add    %rbx,%r13
  402299:	4c 03 6c 24 28       	add    0x28(%rsp),%r13
  40229e:	4c 01 f8             	add    %r15,%rax
  4022a1:	4c 01 e8             	add    %r13,%rax
  4022a4:	b9 ff 03 00 00       	mov    $0x3ff,%ecx
  4022a9:	29 d9                	sub    %ebx,%ecx
  4022ab:	48 63 d1             	movslq %ecx,%rdx
  4022ae:	48 3d ff 03 00 00    	cmp    $0x3ff,%rax
  4022b4:	0f 87 dd 00 00 00    	ja     402397 <__intel_new_feature_proc_init_n+0x2a7>
  4022ba:	b9 00 04 00 00       	mov    $0x400,%ecx
  4022bf:	4d 89 e5             	mov    %r12,%r13
  4022c2:	4c 89 e7             	mov    %r12,%rdi
  4022c5:	48 8d 35 0a 6e 00 00 	lea    0x6e0a(%rip),%rsi        # 4090d6 <_IO_stdin_used+0xd6>
  4022cc:	e8 1f ef ff ff       	call   4011f0 <__strncat_chk@plt>
  4022d1:	4c 89 e7             	mov    %r12,%rdi
  4022d4:	e8 27 ee ff ff       	call   401100 <strlen@plt>
  4022d9:	48 c1 e0 20          	shl    $0x20,%rax
  4022dd:	48 ba 00 00 00 00 ff 	movabs $0x3ff00000000,%rdx
  4022e4:	03 00 00 
  4022e7:	48 29 c2             	sub    %rax,%rdx
  4022ea:	48 c1 fa 20          	sar    $0x20,%rdx
  4022ee:	b9 00 04 00 00       	mov    $0x400,%ecx
  4022f3:	4c 89 e7             	mov    %r12,%rdi
  4022f6:	48 8b 74 24 08       	mov    0x8(%rsp),%rsi
  4022fb:	e8 f0 ee ff ff       	call   4011f0 <__strncat_chk@plt>
  402300:	4c 89 f3             	mov    %r14,%rbx
  402303:	4c 8d 64 24 10       	lea    0x10(%rsp),%r12
  402308:	e9 e1 fe ff ff       	jmp    4021ee <__intel_new_feature_proc_init_n+0xfe>
  40230d:	4c 89 f3             	mov    %r14,%rbx
  402310:	e9 e4 fe ff ff       	jmp    4021f9 <__intel_new_feature_proc_init_n+0x109>
  402315:	bf 01 00 00 00       	mov    $0x1,%edi
  40231a:	31 f6                	xor    %esi,%esi
  40231c:	31 d2                	xor    %edx,%edx
  40231e:	31 c0                	xor    %eax,%eax
  402320:	e8 cb 5f 00 00       	call   4082f0 <__libirc_print>
  402325:	e9 ce 00 00 00       	jmp    4023f8 <__intel_new_feature_proc_init_n+0x308>
  40232a:	48 85 db             	test   %rbx,%rbx
  40232d:	0f 84 ac 00 00 00    	je     4023df <__intel_new_feature_proc_init_n+0x2ef>
  402333:	49 89 dc             	mov    %rbx,%r12
  402336:	b8 ff 03 00 00       	mov    $0x3ff,%eax
  40233b:	44 29 f8             	sub    %r15d,%eax
  40233e:	48 63 d0             	movslq %eax,%rdx
  402341:	eb 59                	jmp    40239c <__intel_new_feature_proc_init_n+0x2ac>
  402343:	bf 01 00 00 00       	mov    $0x1,%edi
  402348:	31 f6                	xor    %esi,%esi
  40234a:	31 d2                	xor    %edx,%edx
  40234c:	31 c0                	xor    %eax,%eax
  40234e:	e8 9d 5f 00 00       	call   4082f0 <__libirc_print>
  402353:	bf 01 00 00 00       	mov    $0x1,%edi
  402358:	be 3b 00 00 00       	mov    $0x3b,%esi
  40235d:	31 d2                	xor    %edx,%edx
  40235f:	31 c0                	xor    %eax,%eax
  402361:	e8 8a 5f 00 00       	call   4082f0 <__libirc_print>
  402366:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  40236d:	00 00 
  40236f:	48 3b 84 24 30 04 00 	cmp    0x430(%rsp),%rax
  402376:	00 
  402377:	0f 85 d8 00 00 00    	jne    402455 <__intel_new_feature_proc_init_n+0x365>
  40237d:	bf 01 00 00 00       	mov    $0x1,%edi
  402382:	31 f6                	xor    %esi,%esi
  402384:	31 d2                	xor    %edx,%edx
  402386:	31 c0                	xor    %eax,%eax
  402388:	e8 63 5f 00 00       	call   4082f0 <__libirc_print>
  40238d:	bf 01 00 00 00       	mov    $0x1,%edi
  402392:	e8 c9 ec ff ff       	call   401060 <exit@plt>
  402397:	4c 8b 64 24 08       	mov    0x8(%rsp),%r12
  40239c:	4c 8d 74 24 30       	lea    0x30(%rsp),%r14
  4023a1:	b9 00 04 00 00       	mov    $0x400,%ecx
  4023a6:	4c 89 f7             	mov    %r14,%rdi
  4023a9:	48 8b 34 24          	mov    (%rsp),%rsi
  4023ad:	e8 3e ee ff ff       	call   4011f0 <__strncat_chk@plt>
  4023b2:	4c 89 f7             	mov    %r14,%rdi
  4023b5:	e8 46 ed ff ff       	call   401100 <strlen@plt>
  4023ba:	48 c1 e0 20          	shl    $0x20,%rax
  4023be:	48 ba 00 00 00 00 ff 	movabs $0x3ff00000000,%rdx
  4023c5:	03 00 00 
  4023c8:	48 29 c2             	sub    %rax,%rdx
  4023cb:	48 c1 fa 20          	sar    $0x20,%rdx
  4023cf:	b9 00 04 00 00       	mov    $0x400,%ecx
  4023d4:	4c 89 f7             	mov    %r14,%rdi
  4023d7:	4c 89 e6             	mov    %r12,%rsi
  4023da:	e8 11 ee ff ff       	call   4011f0 <__strncat_chk@plt>
  4023df:	0f b6 5c 24 30       	movzbl 0x30(%rsp),%ebx
  4023e4:	bf 01 00 00 00       	mov    $0x1,%edi
  4023e9:	31 f6                	xor    %esi,%esi
  4023eb:	31 d2                	xor    %edx,%edx
  4023ed:	31 c0                	xor    %eax,%eax
  4023ef:	e8 fc 5e 00 00       	call   4082f0 <__libirc_print>
  4023f4:	84 db                	test   %bl,%bl
  4023f6:	75 15                	jne    40240d <__intel_new_feature_proc_init_n+0x31d>
  4023f8:	bf 01 00 00 00       	mov    $0x1,%edi
  4023fd:	be 3a 00 00 00       	mov    $0x3a,%esi
  402402:	31 d2                	xor    %edx,%edx
  402404:	31 c0                	xor    %eax,%eax
  402406:	e8 e5 5e 00 00       	call   4082f0 <__libirc_print>
  40240b:	eb 1b                	jmp    402428 <__intel_new_feature_proc_init_n+0x338>
  40240d:	48 8d 4c 24 30       	lea    0x30(%rsp),%rcx
  402412:	bf 01 00 00 00       	mov    $0x1,%edi
  402417:	be 38 00 00 00       	mov    $0x38,%esi
  40241c:	ba 01 00 00 00       	mov    $0x1,%edx
  402421:	31 c0                	xor    %eax,%eax
  402423:	e8 c8 5e 00 00       	call   4082f0 <__libirc_print>
  402428:	bf 01 00 00 00       	mov    $0x1,%edi
  40242d:	31 f6                	xor    %esi,%esi
  40242f:	31 d2                	xor    %edx,%edx
  402431:	31 c0                	xor    %eax,%eax
  402433:	e8 b8 5e 00 00       	call   4082f0 <__libirc_print>
  402438:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  40243f:	00 00 
  402441:	48 3b 84 24 30 04 00 	cmp    0x430(%rsp),%rax
  402448:	00 
  402449:	75 0a                	jne    402455 <__intel_new_feature_proc_init_n+0x365>
  40244b:	bf 01 00 00 00       	mov    $0x1,%edi
  402450:	e8 0b ec ff ff       	call   401060 <exit@plt>
  402455:	e8 26 ed ff ff       	call   401180 <__stack_chk_fail@plt>
  40245a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)

0000000000402460 <__intel_new_feature_proc_init>:
  402460:	f3 0f 1e fa          	endbr64
  402464:	53                   	push   %rbx
  402465:	89 fb                	mov    %edi,%ebx
  402467:	31 ff                	xor    %edi,%edi
  402469:	e8 82 fc ff ff       	call   4020f0 <__intel_new_feature_proc_init_n>
  40246e:	48 c7 c7 a0 c2 40 00 	mov    $0x40c2a0,%rdi
  402475:	be 06 00 00 00       	mov    $0x6,%esi
  40247a:	e8 f1 52 00 00       	call   407770 <__libirc_get_cpu_feature>
  40247f:	83 f8 01             	cmp    $0x1,%eax
  402482:	75 0a                	jne    40248e <__intel_new_feature_proc_init+0x2e>
  402484:	31 ff                	xor    %edi,%edi
  402486:	89 de                	mov    %ebx,%esi
  402488:	5b                   	pop    %rbx
  402489:	e9 52 00 00 00       	jmp    4024e0 <__intel_proc_init_ftzdazule>
  40248e:	85 c0                	test   %eax,%eax
  402490:	78 02                	js     402494 <__intel_new_feature_proc_init+0x34>
  402492:	5b                   	pop    %rbx
  402493:	c3                   	ret
  402494:	bf 01 00 00 00       	mov    $0x1,%edi
  402499:	31 f6                	xor    %esi,%esi
  40249b:	31 d2                	xor    %edx,%edx
  40249d:	31 c0                	xor    %eax,%eax
  40249f:	e8 4c 5e 00 00       	call   4082f0 <__libirc_print>
  4024a4:	bf 01 00 00 00       	mov    $0x1,%edi
  4024a9:	be 3a 00 00 00       	mov    $0x3a,%esi
  4024ae:	31 d2                	xor    %edx,%edx
  4024b0:	31 c0                	xor    %eax,%eax
  4024b2:	e8 39 5e 00 00       	call   4082f0 <__libirc_print>
  4024b7:	bf 01 00 00 00       	mov    $0x1,%edi
  4024bc:	31 f6                	xor    %esi,%esi
  ...
  4024cc:	e8 8f eb ff ff       	call   401060 <exit@plt>
  4024d1:	0f 1f 00             	nopl   (%rax)
  4024d4:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  4024db:	00 00 00 
  4024de:	66 90                	xchg   %ax,%ax

00000000004024e0 <__intel_proc_init_ftzdazule>:
  4024e0:	f3 0f 1e fa          	endbr64
  4024e4:	55                   	push   %rbp
  4024e5:	41 56                	push   %r14
  4024e7:	53                   	push   %rbx
  4024e8:	48 81 ec 20 02 00 00 	sub    $0x220,%rsp
  4024ef:	89 f3                	mov    %esi,%ebx
  4024f1:	41 89 f6             	mov    %esi,%r14d
  4024f4:	41 83 e6 04          	and    $0x4,%r14d
  4024f8:	89 f5                	mov    %esi,%ebp
  4024fa:	83 e5 02             	and    $0x2,%ebp
  4024fd:	74 07                	je     402506 <__intel_proc_init_ftzdazule+0x26>
  4024ff:	89 f8                	mov    %edi,%eax
  402501:	83 e0 02             	and    $0x2,%eax
  402504:	74 12                	je     402518 <__intel_proc_init_ftzdazule+0x38>
  402506:	31 c0                	xor    %eax,%eax
  402508:	45 85 f6             	test   %r14d,%r14d
  40250b:	74 38                	je     402545 <__intel_proc_init_ftzdazule+0x65>
  40250d:	b8 01 00 00 00       	mov    $0x1,%eax
  402512:	40 f6 c7 04          	test   $0x4,%dil
  402516:	75 2d                	jne    402545 <__intel_proc_init_ftzdazule+0x65>
  402518:	48 8d 7c 24 20       	lea    0x20(%rsp),%rdi
  40251d:	ba 00 02 00 00       	mov    $0x200,%edx
  402522:	31 f6                	xor    %esi,%esi
  402524:	e8 d7 ec ff ff       	call   401200 <memset@plt>
  402529:	0f ae 44 24 20       	fxsave 0x20(%rsp)
  40252e:	8b 44 24 3c          	mov    0x3c(%rsp),%eax
  402532:	89 c1                	mov    %eax,%ecx
  402534:	c1 e1 19             	shl    $0x19,%ecx
  402537:	c1 f9 1f             	sar    $0x1f,%ecx
  40253a:	21 cd                	and    %ecx,%ebp
  40253c:	c1 e0 0e             	shl    $0xe,%eax
  40253f:	c1 f8 1f             	sar    $0x1f,%eax
  402542:	44 21 f0             	and    %r14d,%eax
  402545:	f6 c3 01             	test   $0x1,%bl
  402548:	74 17                	je     402561 <__intel_proc_init_ftzdazule+0x81>
  40254a:	0f ae 5c 24 1c       	stmxcsr 0x1c(%rsp)
  40254f:	b9 00 80 00 00       	mov    $0x8000,%ecx
  402554:	0b 4c 24 1c          	or     0x1c(%rsp),%ecx
  402558:	89 4c 24 18          	mov    %ecx,0x18(%rsp)
  40255c:	0f ae 54 24 18       	ldmxcsr 0x18(%rsp)
  402561:	85 ed                	test   %ebp,%ebp
  402563:	74 15                	je     40257a <__intel_proc_init_ftzdazule+0x9a>
  402565:	0f ae 5c 24 14       	stmxcsr 0x14(%rsp)
  40256a:	8b 4c 24 14          	mov    0x14(%rsp),%ecx
  40256e:	83 c9 40             	or     $0x40,%ecx
  402571:	89 4c 24 10          	mov    %ecx,0x10(%rsp)
  402575:	0f ae 54 24 10       	ldmxcsr 0x10(%rsp)
  40257a:	85 c0                	test   %eax,%eax
  40257c:	74 17                	je     402595 <__intel_proc_init_ftzdazule+0xb5>
  40257e:	0f ae 5c 24 0c       	stmxcsr 0xc(%rsp)
  402583:	b8 00 00 02 00       	mov    $0x20000,%eax
  402588:	0b 44 24 0c          	or     0xc(%rsp),%eax
  40258c:	89 44 24 08          	mov    %eax,0x8(%rsp)
  402590:	0f ae 54 24 08       	ldmxcsr 0x8(%rsp)
  402595:	48 81 c4 20 02 00 00 	add    $0x220,%rsp
  40259c:	5b                   	pop    %rbx
  40259d:	41 5e                	pop    %r14
  40259f:	5d                   	pop    %rbp
  4025a0:	c3                   	ret
  4025a1:	0f 1f 00             	nopl   (%rax)
  4025a4:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  4025ab:	00 00 00 
  4025ae:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  4025b5:	00 00 00 

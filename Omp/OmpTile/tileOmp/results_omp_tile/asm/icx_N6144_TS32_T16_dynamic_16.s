...
results_omp_tile/bin/icx_N6144_TS32_T16_dynamic_16:     file format elf64-x86-64
...
0000000000401aa0 <main.extracted.18>:
  ...
  401ace:	00 00 
  401ad0:	48 c7 44 24 10 ff 8f 	movq   $0x8fff,0x10(%rsp)
  401ad7:	00 00 
  ...
  401aef:	41 b8 ff 8f 00 00    	mov    $0x8fff,%r8d
  ...
  401bee:	81 fa bf 00 00 00    	cmp    $0xbf,%edx
  401bf4:	b8 bf 00 00 00       	mov    $0xbf,%eax
  ...
  401c07:	81 fe e0 17 00 00    	cmp    $0x17e0,%esi
  401c0d:	41 b9 e0 17 00 00    	mov    $0x17e0,%r9d
  ...
  401c53:	49 81 c2 00 00 18 00 	add    $0x180000,%r10
  401c5a:	49 81 c3 00 01 00 00 	add    $0x100,%r11
  401c61:	81 fa bf 00 00 00    	cmp    $0xbf,%edx
  ...
  401c84:	81 fe 00 18 00 00    	cmp    $0x1800,%esi
  401c8a:	40 0f 9c c7          	setl   %dil
  401c8e:	31 f6                	xor    %esi,%esi
  401c90:	3d 00 18 00 00       	cmp    $0x1800,%eax
...
0000000000401de0 <main.extracted.25>:
  ...
  401e07:	00 
  401e08:	c7 04 24 ff 17 00 00 	movl   $0x17ff,(%rsp)
  ...
  401e7a:	48 81 c1 00 18 00 00 	add    $0x1800,%rcx

...
base_analysis_results/bin/gcc_O2_N4096:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    1186:	48 3d 00 80 00 00    	cmp    $0x8000,%rax
    118c:	75 b0                	jne    113e <main+0x7e>
    118e:	83 c6 01             	add    $0x1,%esi
    1191:	48 81 c2 00 80 00 00 	add    $0x8000,%rdx
    1198:	48 81 c1 00 80 00 00 	add    $0x8000,%rcx
    119f:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    ...
    11b9:	48 8d bd 00 00 00 08 	lea    0x8000000(%rbp),%rdi
    ...
    11fa:	48 3d 00 80 00 00    	cmp    $0x8000,%rax
    1200:	75 de                	jne    11e0 <main+0x120>
    1202:	48 81 c1 00 80 00 00 	add    $0x8000,%rcx
    1209:	48 83 c6 08          	add    $0x8,%rsi
    120d:	48 39 f9             	cmp    %rdi,%rcx
    1210:	75 be                	jne    11d0 <main+0x110>
    1212:	49 81 c0 00 80 00 00 	add    $0x8000,%r8
    1219:	49 81 f8 00 00 00 08 	cmp    $0x8000000,%r8
    ...
    12a2:	48 8d 83 00 00 05 00 	lea    0x50000(%rbx),%rax
    ...
    12e5:	49 81 c7 00 80 00 00 	add    $0x8000,%r15

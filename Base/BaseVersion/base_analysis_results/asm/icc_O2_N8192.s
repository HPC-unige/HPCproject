...
base_analysis_results/bin/icc_O2_N8192:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  4012a5:	bf 00 00 00 20       	mov    $0x20000000,%edi
  ...
  4012bd:	bf 00 00 00 20       	mov    $0x20000000,%edi
  4012c2:	e8 19 fe ff ff       	call   4010e0 <malloc@plt>
  4012c7:	49 89 c5             	mov    %rax,%r13
  4012ca:	bf 00 00 00 20       	mov    $0x20000000,%edi
  ...
  40138d:	41 8d 85 00 20 00 00 	lea    0x2000(%r13),%eax
  ...
  401574:	42 8d bc 2b 00 20 00 	lea    0x2000(%rbx,%r13,1),%edi
  40157b:	00 
  ...
  4015e7:	48 81 c1 00 00 01 00 	add    $0x10000,%rcx
  4015ee:	49 81 c1 00 00 01 00 	add    $0x10000,%r9
  4015f5:	49 81 c0 00 00 01 00 	add    $0x10000,%r8
  4015fc:	81 fe 00 20 00 00    	cmp    $0x2000,%esi
  ...
  40169e:	81 c3 00 20 00 00    	add    $0x2000,%ebx
  ...
  401798:	41 81 fc 00 20 00 00 	cmp    $0x2000,%r12d
  40179f:	77 31                	ja     4017d2 <main+0x552>
  4017a1:	41 89 dc             	mov    %ebx,%r12d
  4017a4:	41 f7 dc             	neg    %r12d
  4017a7:	41 81 c4 00 20 00 00 	add    $0x2000,%r12d
  ...
  4017d5:	49 81 c3 00 00 01 00 	add    $0x10000,%r11
  4017dc:	49 81 c2 00 00 01 00 	add    $0x10000,%r10
  4017e3:	48 81 fa 00 20 00 00 	cmp    $0x2000,%rdx
  4017ea:	0f 82 70 fe ff ff    	jb     401660 <main+0x3e0>
  4017f0:	8b 04 24             	mov    (%rsp),%eax
  4017f3:	48 81 c7 00 00 01 00 	add    $0x10000,%rdi
  ...
  40180e:	3d 00 20 00 00       	cmp    $0x2000,%eax
  ...
  4018dc:	fe c3                	inc    %bl
  4018de:	49 81 c7 00 00 01 00 	add    $0x10000,%r15
  ...
  40192f:	41 bb 00 20 00 00    	mov    $0x2000,%r11d

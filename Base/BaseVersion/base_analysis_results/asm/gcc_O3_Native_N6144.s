...
base_analysis_results/bin/gcc_O3_Native_N6144:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c9:	bf 00 00 00 12       	mov    $0x12000000,%edi
    ...
    10fc:	bf 00 00 00 12       	mov    $0x12000000,%edi
    ...
    1131:	49 8d b5 00 c0 00 00 	lea    0xc000(%r13),%rsi
    ...
    118b:	48 81 c1 00 c0 00 00 	add    $0xc000,%rcx
    1192:	48 8d b0 00 c0 00 00 	lea    0xc000(%rax),%rsi
    1199:	81 fa 00 18 00 00    	cmp    $0x1800,%edx
    119f:	75 aa                	jne    114b <main+0x8b>
    11a1:	b8 08 00 00 00       	mov    $0x8,%eax
    11a6:	49 8d b4 24 00 c0 00 	lea    0xc000(%r12),%rsi
    11ad:	00 
    ...
    11fc:	48 81 c1 00 c0 00 00 	add    $0xc000,%rcx
    1203:	48 8d b0 00 c0 00 00 	lea    0xc000(%rax),%rsi
    120a:	81 fa 00 18 00 00    	cmp    $0x1800,%edx
    ...
    122a:	4c 8d 9b 00 00 00 12 	lea    0x12000000(%rbx),%r11
    ...
    1250:	48 8d b1 00 c0 00 00 	lea    0xc000(%rcx),%rsi
    ...
    129a:	48 3d 00 c0 00 00    	cmp    $0xc000,%rax
    12a0:	75 be                	jne    1260 <main+0x1a0>
    12a2:	41 83 c0 02          	add    $0x2,%r8d
    12a6:	48 81 c1 00 80 01 00 	add    $0x18000,%rcx
    12ad:	48 83 c7 10          	add    $0x10,%rdi
    12b1:	41 81 f8 01 18 00 00 	cmp    $0x1801,%r8d
    12b8:	75 86                	jne    1240 <main+0x180>
    12ba:	49 81 c1 00 c0 00 00 	add    $0xc000,%r9
    12c1:	49 81 c2 00 c0 00 00 	add    $0xc000,%r10
    ...
    134b:	48 8d 83 00 80 07 00 	lea    0x78000(%rbx),%rax
    ...
    1396:	49 81 c6 00 c0 00 00 	add    $0xc000,%r14

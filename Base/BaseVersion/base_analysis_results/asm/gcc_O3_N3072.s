...
base_analysis_results/bin/gcc_O3_N3072:     file format elf64-x86-64
...
00000000000010c0 <main>:
    10c0:	41 57                	push   %r15
    10c2:	bf 00 00 80 04       	mov    $0x4800000,%edi
    10c7:	41 56                	push   %r14
    10c9:	41 55                	push   %r13
    10cb:	41 54                	push   %r12
    10cd:	55                   	push   %rbp
    ...
    10d8:	bf 00 00 80 04       	mov    $0x4800000,%edi
    ...
    112c:	49 8d b4 24 00 60 00 	lea    0x6000(%r12),%rsi
    1133:	00 
    ...
    1171:	48 81 c1 00 60 00 00 	add    $0x6000,%rcx
    1178:	48 8d b0 00 60 00 00 	lea    0x6000(%rax),%rsi
    117f:	81 fa 00 0c 00 00    	cmp    $0xc00,%edx
    1185:	75 ad                	jne    1134 <main+0x74>
    1187:	48 8d b5 00 60 00 00 	lea    0x6000(%rbp),%rsi
    ...
    11d4:	48 81 c1 00 60 00 00 	add    $0x6000,%rcx
    11db:	48 8d b0 00 60 00 00 	lea    0x6000(%rax),%rsi
    11e2:	81 fa 00 0c 00 00    	cmp    $0xc00,%edx
    ...
    1221:	48 8d b1 00 60 00 00 	lea    0x6000(%rcx),%rsi
    ...
    1288:	48 3d 00 60 00 00    	cmp    $0x6000,%rax
    128e:	75 a8                	jne    1238 <main+0x178>
    1290:	41 83 c0 02          	add    $0x2,%r8d
    1294:	48 81 c1 00 c0 00 00 	add    $0xc000,%rcx
    129b:	48 83 c7 10          	add    $0x10,%rdi
    129f:	41 81 f8 01 0c 00 00 	cmp    $0xc01,%r8d
    12a6:	0f 85 66 ff ff ff    	jne    1212 <main+0x152>
    12ac:	49 81 c1 00 60 00 00 	add    $0x6000,%r9
    12b3:	49 81 f9 00 00 80 04 	cmp    $0x4800000,%r9
    ...
    1340:	4c 8d ab 00 c0 03 00 	lea    0x3c000(%rbx),%r13
    ...
    1386:	49 81 c7 00 60 00 00 	add    $0x6000,%r15

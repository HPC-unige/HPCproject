...
base_analysis_results/bin/icc_O3_Host_N8192:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  4013af:	05 00 20 00 00       	add    $0x2000,%eax
  ...
  4015ce:	49 81 c1 00 00 01 00 	add    $0x10000,%r9
  4015d5:	48 81 c6 00 00 01 00 	add    $0x10000,%rsi
  4015dc:	49 81 c2 00 00 01 00 	add    $0x10000,%r10
  4015e3:	41 81 f8 00 20 00 00 	cmp    $0x2000,%r8d
  ...
  401695:	c4 e2 f9 b9 92 00 00 	vfmadd231sd 0x10000(%rdx),%xmm0,%xmm2
  40169c:	01 00 
  ...
  4016bb:	81 c7 00 20 00 00    	add    $0x2000,%edi
  ...
  401703:	c4 c2 ed b8 a4 c7 00 	vfmadd231pd 0x10000(%r15,%rax,8),%ymm2,%ymm4
  40170a:	00 01 00 
  40170d:	c4 c2 ed b8 ac c7 20 	vfmadd231pd 0x10020(%r15,%rax,8),%ymm2,%ymm5
  401714:	00 01 00 
  401717:	c4 c2 ed b8 b4 c7 40 	vfmadd231pd 0x10040(%r15,%rax,8),%ymm2,%ymm6
  40171e:	00 01 00 
  401721:	c4 c2 ed b8 bc c7 60 	vfmadd231pd 0x10060(%r15,%rax,8),%ymm2,%ymm7
  401728:	00 01 00 
  ...
  401797:	c4 82 ed b8 a4 ef 00 	vfmadd231pd 0x10000(%r15,%r13,8),%ymm2,%ymm4
  40179e:	00 01 00 
  ...
  4017c3:	c4 c2 f9 b9 94 c7 00 	vfmadd231sd 0x10000(%r15,%rax,8),%xmm0,%xmm2
  4017ca:	00 01 00 
  ...
  4017da:	49 81 c7 00 00 02 00 	add    $0x20000,%r15
  4017e1:	48 83 c6 10          	add    $0x10,%rsi
  4017e5:	41 81 fe 00 10 00 00 	cmp    $0x1000,%r14d
  ...
  4017ff:	48 05 00 00 01 00    	add    $0x10000,%rax
  401805:	48 8b 5c 24 30       	mov    0x30(%rsp),%rbx
  40180a:	4c 8b 6c 24 28       	mov    0x28(%rsp),%r13
  40180f:	81 fa 00 20 00 00    	cmp    $0x2000,%edx
  ...
  4018e5:	48 81 c3 00 00 01 00 	add    $0x10000,%rbx

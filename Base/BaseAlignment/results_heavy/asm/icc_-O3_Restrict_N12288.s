...
results_heavy/bin/icc_-O3_Restrict_N12288:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  40138f:	41 81 c6 00 30 00 00 	add    $0x3000,%r14d
  ...
  4013fe:	41 81 fa 00 30 00 00 	cmp    $0x3000,%r10d
  401405:	77 62                	ja     401469 <main+0x1e9>
  401407:	45 89 f3             	mov    %r14d,%r11d
  40140a:	41 f7 db             	neg    %r11d
  40140d:	41 81 c3 00 30 00 00 	add    $0x3000,%r11d
  ...
  40146c:	48 05 00 80 01 00    	add    $0x18000,%rax
  401472:	49 81 c1 00 80 01 00 	add    $0x18000,%r9
  401479:	48 81 c2 00 80 01 00 	add    $0x18000,%rdx
  401480:	41 81 f8 00 30 00 00 	cmp    $0x3000,%r8d
  ...
  401535:	c4 e2 f9 b9 92 00 80 	vfmadd231sd 0x18000(%rdx),%xmm0,%xmm2
  40153c:	01 00 
  ...
  40155b:	81 c7 00 30 00 00    	add    $0x3000,%edi
  ...
  4015a3:	c4 c2 ed b8 a4 c6 00 	vfmadd231pd 0x18000(%r14,%rax,8),%ymm2,%ymm4
  4015aa:	80 01 00 
  4015ad:	c4 c2 ed b8 ac c6 20 	vfmadd231pd 0x18020(%r14,%rax,8),%ymm2,%ymm5
  4015b4:	80 01 00 
  4015b7:	c4 c2 ed b8 b4 c6 40 	vfmadd231pd 0x18040(%r14,%rax,8),%ymm2,%ymm6
  4015be:	80 01 00 
  4015c1:	c4 c2 ed b8 bc c6 60 	vfmadd231pd 0x18060(%r14,%rax,8),%ymm2,%ymm7
  4015c8:	80 01 00 
  ...
  401637:	c4 82 ed b8 a4 fe 00 	vfmadd231pd 0x18000(%r14,%r15,8),%ymm2,%ymm4
  40163e:	80 01 00 
  ...
  401663:	c4 c2 f9 b9 94 c6 00 	vfmadd231sd 0x18000(%r14,%rax,8),%xmm0,%xmm2
  40166a:	80 01 00 
  ...
  40167a:	49 81 c6 00 00 03 00 	add    $0x30000,%r14
  401681:	48 83 c6 10          	add    $0x10,%rsi
  401685:	41 81 fd 00 18 00 00 	cmp    $0x1800,%r13d
  ...
  40169f:	48 05 00 80 01 00    	add    $0x18000,%rax
  4016a5:	48 8b 5c 24 30       	mov    0x30(%rsp),%rbx
  4016aa:	4c 8b 7c 24 28       	mov    0x28(%rsp),%r15
  4016af:	81 fa 00 30 00 00    	cmp    $0x3000,%edx
  ...
  4017a7:	48 81 c3 00 80 01 00 	add    $0x18000,%rbx

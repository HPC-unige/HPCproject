...
results_heavy/bin/icc_-O2_Restrict_N5000:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  4012a3:	bf 00 c2 eb 0b       	mov    $0xbebc200,%edi
  ...
  4012bb:	bf 00 c2 eb 0b       	mov    $0xbebc200,%edi
  4012c0:	e8 1b fe ff ff       	call   4010e0 <malloc@plt>
  4012c5:	49 89 c5             	mov    %rax,%r13
  4012c8:	bf 00 c2 eb 0b       	mov    $0xbebc200,%edi
  ...
  401338:	48 05 40 78 7d 01    	add    $0x17d7840,%rax
  ...
  401392:	48 3d 40 78 7d 01    	cmp    $0x17d7840,%rax
  ...
  4013c0:	48 3d 40 78 7d 01    	cmp    $0x17d7840,%rax
  ...
  401451:	41 81 c4 88 13 00 00 	add    $0x1388,%r12d
  ...
  40154a:	41 81 fe 88 13 00 00 	cmp    $0x1388,%r14d
  401551:	77 31                	ja     401584 <main+0x304>
  401553:	45 89 e6             	mov    %r12d,%r14d
  401556:	41 f7 de             	neg    %r14d
  401559:	41 81 c6 88 13 00 00 	add    $0x1388,%r14d
  ...
  401587:	49 81 c0 40 9c 00 00 	add    $0x9c40,%r8
  40158e:	48 81 c2 40 9c 00 00 	add    $0x9c40,%rdx
  401595:	49 81 fa 88 13 00 00 	cmp    $0x1388,%r10
  ...
  4015ac:	49 81 c7 40 9c 00 00 	add    $0x9c40,%r15
  4015b3:	48 8b 5c 24 38       	mov    0x38(%rsp),%rbx
  4015b8:	4c 8b 74 24 30       	mov    0x30(%rsp),%r14
  4015bd:	81 ff 88 13 00 00    	cmp    $0x1388,%edi
  ...
  4016ba:	48 81 c3 40 9c 00 00 	add    $0x9c40,%rbx

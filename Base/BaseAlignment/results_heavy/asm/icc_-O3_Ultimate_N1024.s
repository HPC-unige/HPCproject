...
results_heavy/bin/icc_-O3_Ultimate_N1024:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  4012e0:	ba 00 00 80 00       	mov    $0x800000,%edx
  ...
  4012fc:	ba 00 00 80 00       	mov    $0x800000,%edx
  ...
  4013ca:	41 81 c5 00 04 00 00 	add    $0x400,%r13d
  ...
  4014ae:	48 81 c2 00 20 00 00 	add    $0x2000,%rdx
  4014b5:	49 81 c0 00 20 00 00 	add    $0x2000,%r8
  4014bc:	49 81 c1 00 20 00 00 	add    $0x2000,%r9
  4014c3:	81 ff 00 04 00 00    	cmp    $0x400,%edi
  ...
  40159c:	c4 e2 f9 b9 92 00 20 	vfmadd231sd 0x2000(%rdx),%xmm0,%xmm2
  4015a3:	00 00 
  ...
  4015c2:	81 c3 00 04 00 00    	add    $0x400,%ebx
  ...
  40160a:	c4 c2 ed b8 a4 c1 00 	vfmadd231pd 0x2000(%r9,%rax,8),%ymm2,%ymm4
  401611:	20 00 00 
  401614:	c4 c2 ed b8 ac c1 20 	vfmadd231pd 0x2020(%r9,%rax,8),%ymm2,%ymm5
  40161b:	20 00 00 
  40161e:	c4 c2 ed b8 b4 c1 40 	vfmadd231pd 0x2040(%r9,%rax,8),%ymm2,%ymm6
  401625:	20 00 00 
  401628:	c4 c2 ed b8 bc c1 60 	vfmadd231pd 0x2060(%r9,%rax,8),%ymm2,%ymm7
  40162f:	20 00 00 
  ...
  40169d:	c4 c2 ed b8 a4 f1 00 	vfmadd231pd 0x2000(%r9,%rsi,8),%ymm2,%ymm4
  4016a4:	20 00 00 
  ...
  4016c9:	c4 c2 f9 b9 94 c1 00 	vfmadd231sd 0x2000(%r9,%rax,8),%xmm0,%xmm2
  4016d0:	20 00 00 
  ...
  4016e0:	49 81 c1 00 40 00 00 	add    $0x4000,%r9
  4016e7:	49 83 c7 10          	add    $0x10,%r15
  4016eb:	41 81 f8 00 02 00 00 	cmp    $0x200,%r8d
  ...
  401705:	48 05 00 20 00 00    	add    $0x2000,%rax
  40170b:	48 8b 4c 24 40       	mov    0x40(%rsp),%rcx
  401710:	48 8b 54 24 18       	mov    0x18(%rsp),%rdx
  401715:	81 fe 00 04 00 00    	cmp    $0x400,%esi
  ...
  40182b:	49 81 c4 00 20 00 00 	add    $0x2000,%r12

...
results_heavy/bin/gcc_Restrict_-O2_3072:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    112d:	49 8d b4 24 00 00 80 	lea    0x4800000(%r12),%rsi
    1134:	04 
    ...
    114b:	48 3d 00 60 00 00    	cmp    $0x6000,%rax
    1151:	75 ec                	jne    113f <main+0x7f>
    1153:	48 81 c2 00 60 00 00 	add    $0x6000,%rdx
    ...
    1178:	48 8d bd 00 00 80 04 	lea    0x4800000(%rbp),%rdi
    ...
    11ba:	48 3d 00 60 00 00    	cmp    $0x6000,%rax
    11c0:	75 de                	jne    11a0 <main+0xe0>
    11c2:	48 81 c1 00 60 00 00 	add    $0x6000,%rcx
    11c9:	48 83 c6 08          	add    $0x8,%rsi
    11cd:	48 39 f9             	cmp    %rdi,%rcx
    11d0:	75 be                	jne    1190 <main+0xd0>
    11d2:	49 81 c1 00 60 00 00 	add    $0x6000,%r9
    11d9:	49 81 f9 00 00 80 04 	cmp    $0x4800000,%r9
    ...
    1266:	48 8d 83 00 c0 03 00 	lea    0x3c000(%rbx),%rax
    ...
    12c8:	49 81 c6 00 60 00 00 	add    $0x6000,%r14

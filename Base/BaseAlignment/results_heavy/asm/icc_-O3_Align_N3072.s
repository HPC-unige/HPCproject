...
results_heavy/bin/icc_-O3_Align_N3072:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  4012d3:	ba 00 00 80 04       	mov    $0x4800000,%edx
  ...
  4012ef:	ba 00 00 80 04       	mov    $0x4800000,%edx
  ...
  4013be:	41 81 c5 00 0c 00 00 	add    $0xc00,%r13d
  ...
  40149e:	49 81 c0 00 60 00 00 	add    $0x6000,%r8
  4014a5:	49 81 c1 00 60 00 00 	add    $0x6000,%r9
  4014ac:	48 81 c7 00 60 00 00 	add    $0x6000,%rdi
  4014b3:	3d 00 0c 00 00       	cmp    $0xc00,%eax
  ...
  40158b:	c4 e2 f9 b9 92 00 60 	vfmadd231sd 0x6000(%rdx),%xmm0,%xmm2
  401592:	00 00 
  ...
  4015b1:	81 c3 00 0c 00 00    	add    $0xc00,%ebx
  ...
  4015f9:	c4 c2 ed b8 a4 c1 00 	vfmadd231pd 0x6000(%r9,%rax,8),%ymm2,%ymm4
  401600:	60 00 00 
  401603:	c4 c2 ed b8 ac c1 20 	vfmadd231pd 0x6020(%r9,%rax,8),%ymm2,%ymm5
  40160a:	60 00 00 
  40160d:	c4 c2 ed b8 b4 c1 40 	vfmadd231pd 0x6040(%r9,%rax,8),%ymm2,%ymm6
  401614:	60 00 00 
  401617:	c4 c2 ed b8 bc c1 60 	vfmadd231pd 0x6060(%r9,%rax,8),%ymm2,%ymm7
  40161e:	60 00 00 
  ...
  40168c:	c4 c2 ed b8 a4 f1 00 	vfmadd231pd 0x6000(%r9,%rsi,8),%ymm2,%ymm4
  401693:	60 00 00 
  ...
  4016b8:	c4 c2 f9 b9 94 c1 00 	vfmadd231sd 0x6000(%r9,%rax,8),%xmm0,%xmm2
  4016bf:	60 00 00 
  ...
  4016cf:	49 81 c1 00 c0 00 00 	add    $0xc000,%r9
  4016d6:	49 83 c7 10          	add    $0x10,%r15
  4016da:	41 81 f8 00 06 00 00 	cmp    $0x600,%r8d
  ...
  4016f4:	48 05 00 60 00 00    	add    $0x6000,%rax
  4016fa:	48 8b 4c 24 50       	mov    0x50(%rsp),%rcx
  4016ff:	48 8b 54 24 18       	mov    0x18(%rsp),%rdx
  401704:	81 fe 00 0c 00 00    	cmp    $0xc00,%esi
  ...
  40181a:	49 81 c4 00 60 00 00 	add    $0x6000,%r12

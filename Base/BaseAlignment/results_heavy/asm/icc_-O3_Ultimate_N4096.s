...
results_heavy/bin/icc_-O3_Ultimate_N4096:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  4012b2:	ba 00 00 00 08       	mov    $0x8000000,%edx
  ...
  4012e0:	ba 00 00 00 08       	mov    $0x8000000,%edx
  ...
  4012fc:	ba 00 00 00 08       	mov    $0x8000000,%edx
  ...
  4013ca:	41 81 c5 00 10 00 00 	add    $0x1000,%r13d
  ...
  40143e:	41 81 fa 00 10 00 00 	cmp    $0x1000,%r10d
  401445:	77 65                	ja     4014ac <main+0x22c>
  401447:	45 89 ec             	mov    %r13d,%r12d
  40144a:	41 f7 dc             	neg    %r12d
  40144d:	41 81 c4 00 10 00 00 	add    $0x1000,%r12d
  ...
  4014ae:	48 81 c2 00 80 00 00 	add    $0x8000,%rdx
  4014b5:	49 81 c0 00 80 00 00 	add    $0x8000,%r8
  4014bc:	49 81 c1 00 80 00 00 	add    $0x8000,%r9
  4014c3:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
  ...
  40159c:	c4 e2 f9 b9 92 00 80 	vfmadd231sd 0x8000(%rdx),%xmm0,%xmm2
  4015a3:	00 00 
  ...
  4015c2:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  ...
  40160a:	c4 c2 ed b8 a4 c1 00 	vfmadd231pd 0x8000(%r9,%rax,8),%ymm2,%ymm4
  401611:	80 00 00 
  401614:	c4 c2 ed b8 ac c1 20 	vfmadd231pd 0x8020(%r9,%rax,8),%ymm2,%ymm5
  40161b:	80 00 00 
  40161e:	c4 c2 ed b8 b4 c1 40 	vfmadd231pd 0x8040(%r9,%rax,8),%ymm2,%ymm6
  401625:	80 00 00 
  401628:	c4 c2 ed b8 bc c1 60 	vfmadd231pd 0x8060(%r9,%rax,8),%ymm2,%ymm7
  40162f:	80 00 00 
  ...
  40169d:	c4 c2 ed b8 a4 f1 00 	vfmadd231pd 0x8000(%r9,%rsi,8),%ymm2,%ymm4
  4016a4:	80 00 00 
  ...
  4016c9:	c4 c2 f9 b9 94 c1 00 	vfmadd231sd 0x8000(%r9,%rax,8),%xmm0,%xmm2
  4016d0:	80 00 00 
  ...
  4016e0:	49 81 c1 00 00 01 00 	add    $0x10000,%r9
  4016e7:	49 83 c7 10          	add    $0x10,%r15
  4016eb:	41 81 f8 00 08 00 00 	cmp    $0x800,%r8d
  ...
  401705:	48 05 00 80 00 00    	add    $0x8000,%rax
  40170b:	48 8b 4c 24 40       	mov    0x40(%rsp),%rcx
  401710:	48 8b 54 24 18       	mov    0x18(%rsp),%rdx
  401715:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
  ...
  40182b:	49 81 c4 00 80 00 00 	add    $0x8000,%r12

...
results_heavy/bin/gcc_Ultimate_-O3_12288:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    1165:	00 
    1166:	4c 8d 82 08 00 00 48 	lea    0x48000008(%rdx),%r8
    ...
    11c4:	48 3d 00 80 01 00    	cmp    $0x18000,%rax
    11ca:	75 e5                	jne    11b1 <main+0x101>
    11cc:	48 81 c7 00 80 01 00 	add    $0x18000,%rdi
    11d3:	48 81 c6 00 80 01 00 	add    $0x18000,%rsi
    11da:	48 81 c2 00 80 01 00 	add    $0x18000,%rdx
    11e1:	48 81 c1 00 80 01 00 	add    $0x18000,%rcx
    ...
    120a:	4d 8d 90 00 00 00 48 	lea    0x48000000(%r8),%r10
    1211:	49 8d b9 00 00 00 48 	lea    0x48000000(%r9),%rdi
    ...
    1253:	48 3d 00 80 01 00    	cmp    $0x18000,%rax
    1259:	75 e5                	jne    1240 <main+0x190>
    125b:	48 81 c1 00 80 01 00 	add    $0x18000,%rcx
    1262:	48 83 c6 08          	add    $0x8,%rsi
    1266:	48 39 cf             	cmp    %rcx,%rdi
    1269:	75 b5                	jne    1220 <main+0x170>
    126b:	49 81 c0 00 80 01 00 	add    $0x18000,%r8
    1272:	48 81 c2 00 80 01 00 	add    $0x18000,%rdx
    ...
    135c:	49 81 c6 00 80 01 00 	add    $0x18000,%r14
    1363:	e8 f8 fc ff ff       	call   1060 <fputc@plt>
    1368:	49 81 fe 00 00 0f 00 	cmp    $0xf0000,%r14
    ...
    13d0:	48 3d 00 80 01 00    	cmp    $0x18000,%rax
    ...
    13f3:	48 3d 00 80 01 00    	cmp    $0x18000,%rax
    13f9:	75 e5                	jne    13e0 <main+0x330>
    13fb:	48 81 c1 00 80 01 00 	add    $0x18000,%rcx

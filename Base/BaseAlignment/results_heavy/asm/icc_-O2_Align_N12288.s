...
results_heavy/bin/icc_-O2_Align_N12288:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  4012ce:	ba 00 00 00 48       	mov    $0x48000000,%edx
  ...
  401376:	48 81 c7 00 00 00 09 	add    $0x9000000,%rdi
  ...
  4013ca:	48 81 ff 00 00 00 09 	cmp    $0x9000000,%rdi
  ...
  4013f9:	48 81 ff 00 00 00 09 	cmp    $0x9000000,%rdi
  ...
  4014a9:	81 c3 00 30 00 00    	add    $0x3000,%ebx
  ...
  4015a3:	81 fe 00 30 00 00    	cmp    $0x3000,%esi
  4015a9:	77 2c                	ja     4015d7 <main+0x357>
  4015ab:	89 de                	mov    %ebx,%esi
  4015ad:	f7 de                	neg    %esi
  4015af:	81 c6 00 30 00 00    	add    $0x3000,%esi
  ...
  4015da:	49 81 c6 00 80 01 00 	add    $0x18000,%r14
  4015e1:	49 81 c5 00 80 01 00 	add    $0x18000,%r13
  4015e8:	49 81 f9 00 30 00 00 	cmp    $0x3000,%r9
  ...
  401600:	48 81 c2 00 80 01 00 	add    $0x18000,%rdx
  401607:	48 8b 5c 24 18       	mov    0x18(%rsp),%rbx
  40160c:	48 8b 74 24 10       	mov    0x10(%rsp),%rsi
  401611:	81 ff 00 30 00 00    	cmp    $0x3000,%edi
  ...
  401724:	49 81 c4 00 80 01 00 	add    $0x18000,%r12

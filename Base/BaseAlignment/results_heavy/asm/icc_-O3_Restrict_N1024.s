...
results_heavy/bin/icc_-O3_Restrict_N1024:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  40138f:	41 81 c6 00 04 00 00 	add    $0x400,%r14d
  ...
  40146c:	48 05 00 20 00 00    	add    $0x2000,%rax
  401472:	49 81 c1 00 20 00 00 	add    $0x2000,%r9
  401479:	48 81 c2 00 20 00 00 	add    $0x2000,%rdx
  401480:	41 81 f8 00 04 00 00 	cmp    $0x400,%r8d
  ...
  401535:	c4 e2 f9 b9 92 00 20 	vfmadd231sd 0x2000(%rdx),%xmm0,%xmm2
  40153c:	00 00 
  ...
  40155b:	81 c7 00 04 00 00    	add    $0x400,%edi
  ...
  4015a3:	c4 c2 ed b8 a4 c6 00 	vfmadd231pd 0x2000(%r14,%rax,8),%ymm2,%ymm4
  4015aa:	20 00 00 
  4015ad:	c4 c2 ed b8 ac c6 20 	vfmadd231pd 0x2020(%r14,%rax,8),%ymm2,%ymm5
  4015b4:	20 00 00 
  4015b7:	c4 c2 ed b8 b4 c6 40 	vfmadd231pd 0x2040(%r14,%rax,8),%ymm2,%ymm6
  4015be:	20 00 00 
  4015c1:	c4 c2 ed b8 bc c6 60 	vfmadd231pd 0x2060(%r14,%rax,8),%ymm2,%ymm7
  4015c8:	20 00 00 
  ...
  401637:	c4 82 ed b8 a4 fe 00 	vfmadd231pd 0x2000(%r14,%r15,8),%ymm2,%ymm4
  40163e:	20 00 00 
  ...
  401663:	c4 c2 f9 b9 94 c6 00 	vfmadd231sd 0x2000(%r14,%rax,8),%xmm0,%xmm2
  40166a:	20 00 00 
  ...
  40167a:	49 81 c6 00 40 00 00 	add    $0x4000,%r14
  401681:	48 83 c6 10          	add    $0x10,%rsi
  401685:	41 81 fd 00 02 00 00 	cmp    $0x200,%r13d
  ...
  40169f:	48 05 00 20 00 00    	add    $0x2000,%rax
  4016a5:	48 8b 5c 24 30       	mov    0x30(%rsp),%rbx
  4016aa:	4c 8b 7c 24 28       	mov    0x28(%rsp),%r15
  4016af:	81 fa 00 04 00 00    	cmp    $0x400,%edx
  ...
  4017a7:	48 81 c3 00 20 00 00 	add    $0x2000,%rbx

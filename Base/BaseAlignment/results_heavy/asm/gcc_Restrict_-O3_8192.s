...
results_heavy/bin/gcc_Restrict_-O3_8192:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c9:	bf 00 00 00 20       	mov    $0x20000000,%edi
    ...
    1135:	49 8d 95 00 00 01 00 	lea    0x10000(%r13),%rdx
    113c:	49 8d b5 00 00 01 20 	lea    0x20010000(%r13),%rsi
    ...
    1153:	48 8d 90 00 00 01 00 	lea    0x10000(%rax),%rdx
    115a:	48 81 c1 00 00 01 00 	add    $0x10000,%rcx
    ...
    116d:	00 00 
    116f:	49 8d 94 24 00 00 01 	lea    0x10000(%r12),%rdx
    1176:	00 
    1177:	49 8d b4 24 00 00 01 	lea    0x20010000(%r12),%rsi
    117e:	20 
    ...
    1192:	48 81 c2 00 00 01 00 	add    $0x10000,%rdx
    1199:	48 81 c1 00 00 01 00 	add    $0x10000,%rcx
    ...
    11bd:	4c 8d 9b 00 00 00 20 	lea    0x20000000(%rbx),%r11
    ...
    11e3:	48 8d b1 00 00 01 00 	lea    0x10000(%rcx),%rsi
    ...
    122a:	48 3d 00 00 01 00    	cmp    $0x10000,%rax
    1230:	75 be                	jne    11f0 <main+0x130>
    1232:	41 83 c0 02          	add    $0x2,%r8d
    1236:	48 81 c1 00 00 02 00 	add    $0x20000,%rcx
    123d:	48 83 c7 10          	add    $0x10,%rdi
    1241:	41 81 f8 01 20 00 00 	cmp    $0x2001,%r8d
    1248:	75 89                	jne    11d3 <main+0x113>
    124a:	49 81 c1 00 00 01 00 	add    $0x10000,%r9
    1251:	49 81 c2 00 00 01 00 	add    $0x10000,%r10
    ...
    12df:	48 8d 83 00 00 0a 00 	lea    0xa0000(%rbx),%rax
    ...
    1346:	49 81 c7 00 00 01 00 	add    $0x10000,%r15

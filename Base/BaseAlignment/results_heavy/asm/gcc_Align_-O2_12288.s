...
results_heavy/bin/gcc_Align_-O2_12288:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    11e7:	48 3d 00 80 01 00    	cmp    $0x18000,%rax
    11ed:	75 e1                	jne    11d0 <main+0x120>
    11ef:	48 81 c1 00 80 01 00 	add    $0x18000,%rcx
    11f6:	48 83 c6 08          	add    $0x8,%rsi
    11fa:	48 39 cf             	cmp    %rcx,%rdi
    11fd:	75 c1                	jne    11c0 <main+0x110>
    11ff:	48 81 c2 00 80 01 00 	add    $0x18000,%rdx
    1206:	49 81 c0 00 80 01 00 	add    $0x18000,%r8
    ...
    12fd:	49 81 c5 00 80 01 00 	add    $0x18000,%r13
    1304:	e8 57 fd ff ff       	call   1060 <fputc@plt>
    1309:	49 81 fd 00 00 0f 00 	cmp    $0xf0000,%r13

...
results_heavy/bin/gcc_Ultimate_-O2_10240:     file format elf64-x86-64
...
00000000000010b0 <main>:
    10b0:	41 57                	push   %r15
    10b2:	ba 00 00 00 32       	mov    $0x32000000,%edx
    ...
    10f1:	ba 00 00 00 32       	mov    $0x32000000,%edx
    ...
    1109:	ba 00 00 00 32       	mov    $0x32000000,%edx
    ...
    1176:	48 3d 00 40 01 00    	cmp    $0x14000,%rax
    117c:	75 e2                	jne    1160 <main+0xb0>
    117e:	48 81 c7 00 40 01 00 	add    $0x14000,%rdi
    1185:	48 81 ff 00 00 00 32 	cmp    $0x32000000,%rdi
    ...
    11ac:	4c 8d 92 00 00 00 32 	lea    0x32000000(%rdx),%r10
    11b3:	49 8d b9 00 00 00 32 	lea    0x32000000(%r9),%rdi
    ...
    11e7:	48 3d 00 40 01 00    	cmp    $0x14000,%rax
    11ed:	75 e1                	jne    11d0 <main+0x120>
    11ef:	48 81 c1 00 40 01 00 	add    $0x14000,%rcx
    11f6:	48 83 c6 08          	add    $0x8,%rsi
    11fa:	48 39 cf             	cmp    %rcx,%rdi
    11fd:	75 c1                	jne    11c0 <main+0x110>
    11ff:	48 81 c2 00 40 01 00 	add    $0x14000,%rdx
    1206:	49 81 c0 00 40 01 00 	add    $0x14000,%r8
    ...
    12fd:	49 81 c5 00 40 01 00 	add    $0x14000,%r13
    1304:	e8 57 fd ff ff       	call   1060 <fputc@plt>
    1309:	49 81 fd 00 80 0c 00 	cmp    $0xc8000,%r13

...
results_heavy/bin/icc_-O2_Restrict_N1024:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  4012a3:	bf 00 00 80 00       	mov    $0x800000,%edi
  ...
  4012bb:	bf 00 00 80 00       	mov    $0x800000,%edi
  4012c0:	e8 1b fe ff ff       	call   4010e0 <malloc@plt>
  4012c5:	49 89 c5             	mov    %rax,%r13
  4012c8:	bf 00 00 80 00       	mov    $0x800000,%edi
  ...
  401338:	48 05 00 00 10 00    	add    $0x100000,%rax
  ...
  401392:	48 3d 00 00 10 00    	cmp    $0x100000,%rax
  ...
  4013c0:	48 3d 00 00 10 00    	cmp    $0x100000,%rax
  ...
  401451:	41 81 c4 00 04 00 00 	add    $0x400,%r12d
  ...
  401587:	49 81 c0 00 20 00 00 	add    $0x2000,%r8
  40158e:	48 81 c2 00 20 00 00 	add    $0x2000,%rdx
  401595:	49 81 fa 00 04 00 00 	cmp    $0x400,%r10
  ...
  4015ac:	49 81 c7 00 20 00 00 	add    $0x2000,%r15
  4015b3:	48 8b 5c 24 38       	mov    0x38(%rsp),%rbx
  4015b8:	4c 8b 74 24 30       	mov    0x30(%rsp),%r14
  4015bd:	81 ff 00 04 00 00    	cmp    $0x400,%edi
  ...
  4016ba:	48 81 c3 00 20 00 00 	add    $0x2000,%rbx

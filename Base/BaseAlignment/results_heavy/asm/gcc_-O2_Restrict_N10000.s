...
results_heavy/bin/gcc_-O2_Restrict_N10000:     file format elf64-x86-64
...
00000000000010c0 <main>:
    10c0:	41 57                	push   %r15
    10c2:	bf 00 08 af 2f       	mov    $0x2faf0800,%edi
    10c7:	41 56                	push   %r14
    10c9:	41 55                	push   %r13
    10cb:	41 54                	push   %r12
    10cd:	55                   	push   %rbp
    ...
    112d:	49 8d b4 24 00 08 af 	lea    0x2faf0800(%r12),%rsi
    1134:	2f 
    ...
    114b:	48 3d 80 38 01 00    	cmp    $0x13880,%rax
    1151:	75 ec                	jne    113f <main+0x7f>
    1153:	48 81 c2 80 38 01 00 	add    $0x13880,%rdx
    115a:	48 81 c1 80 38 01 00 	add    $0x13880,%rcx
    ...
    1178:	48 8d bd 00 08 af 2f 	lea    0x2faf0800(%rbp),%rdi
    ...
    11ba:	48 3d 80 38 01 00    	cmp    $0x13880,%rax
    11c0:	75 de                	jne    11a0 <main+0xe0>
    11c2:	48 81 c1 80 38 01 00 	add    $0x13880,%rcx
    11c9:	48 83 c6 08          	add    $0x8,%rsi
    11cd:	48 39 f9             	cmp    %rdi,%rcx
    11d0:	75 be                	jne    1190 <main+0xd0>
    11d2:	49 81 c1 80 38 01 00 	add    $0x13880,%r9
    11d9:	49 81 f9 00 08 af 2f 	cmp    $0x2faf0800,%r9
    ...
    1266:	48 8d 83 00 35 0c 00 	lea    0xc3500(%rbx),%rax
    ...
    12c8:	49 81 c6 80 38 01 00 	add    $0x13880,%r14

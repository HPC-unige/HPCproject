...
results_heavy/bin/icc_-O2_Ultimate_N4096:     file format elf64-x86-64
...
0000000000401280 <main>:
  ...
  4012ae:	ba 00 00 00 08       	mov    $0x8000000,%edx
  ...
  4012db:	ba 00 00 00 08       	mov    $0x8000000,%edx
  ...
  4012f7:	ba 00 00 00 08       	mov    $0x8000000,%edx
  ...
  401383:	49 81 c0 00 00 00 01 	add    $0x1000000,%r8
  ...
  4013d7:	49 81 f8 00 00 00 01 	cmp    $0x1000000,%r8
  ...
  401403:	49 81 f8 00 00 00 01 	cmp    $0x1000000,%r8
  ...
  4014b7:	81 c1 00 10 00 00    	add    $0x1000,%ecx
  ...
  4015b5:	81 fb 00 10 00 00    	cmp    $0x1000,%ebx
  4015bb:	77 2e                	ja     4015eb <main+0x36b>
  4015bd:	89 cb                	mov    %ecx,%ebx
  4015bf:	f7 db                	neg    %ebx
  4015c1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  ...
  4015ee:	49 81 c2 00 80 00 00 	add    $0x8000,%r10
  4015f5:	49 81 c7 00 80 00 00 	add    $0x8000,%r15
  4015fc:	49 81 fb 00 10 00 00 	cmp    $0x1000,%r11
  ...
  401618:	48 81 c2 00 80 00 00 	add    $0x8000,%rdx
  40161f:	48 8b 4c 24 18       	mov    0x18(%rsp),%rcx
  401624:	48 8b 74 24 10       	mov    0x10(%rsp),%rsi
  401629:	41 81 f8 00 10 00 00 	cmp    $0x1000,%r8d
  ...
  40173d:	49 81 c4 00 80 00 00 	add    $0x8000,%r12

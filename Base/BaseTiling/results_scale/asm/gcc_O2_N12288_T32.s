...
results_scale/bin/gcc_O2_N12288_T32:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    110d:	ba 00 00 00 48       	mov    $0x48000000,%edx
    ...
    1124:	ba 00 00 00 48       	mov    $0x48000000,%edx
    ...
    1198:	48 81 fa 00 80 01 00 	cmp    $0x18000,%rdx
    119f:	75 df                	jne    1180 <main+0xd0>
    11a1:	48 05 00 80 01 00    	add    $0x18000,%rax
    11a7:	48 3d 00 00 00 48    	cmp    $0x48000000,%rax
    ...
    1231:	4d 8d 4c 1a 20       	lea    0x20(%r10,%rbx,1),%r9
    ...
    124a:	45 8d 59 20          	lea    0x20(%r9),%r11d
    ...
    127b:	4d 8d b0 00 ff ff ff 	lea    -0x100(%r8),%r14
    ...
    12b5:	48 81 ff 00 01 00 00 	cmp    $0x100,%rdi
    12bc:	75 e2                	jne    12a0 <main+0x1f0>
    12be:	49 83 c6 08          	add    $0x8,%r14
    12c2:	49 81 c5 00 80 01 00 	add    $0x18000,%r13
    12c9:	4d 39 c6             	cmp    %r8,%r14
    12cc:	75 c2                	jne    1290 <main+0x1e0>
    12ce:	49 81 c0 00 80 01 00 	add    $0x18000,%r8
    12d5:	48 81 c2 00 80 01 00 	add    $0x18000,%rdx
    ...
    12f5:	49 83 c1 20          	add    $0x20,%r9
    12f9:	48 81 45 88 00 01 00 	addq   $0x100,-0x78(%rbp)
    1300:	00 
    1301:	49 81 f9 00 30 00 00 	cmp    $0x3000,%r9
    1308:	0f 85 39 ff ff ff    	jne    1247 <main+0x197>
    130e:	49 89 c3             	mov    %rax,%r11
    1311:	49 81 c5 00 00 30 00 	add    $0x300000,%r13
    1318:	41 89 cf             	mov    %ecx,%r15d
    131b:	48 8b 95 68 ff ff ff 	mov    -0x98(%rbp),%rdx
    1322:	49 81 fb 00 30 00 00 	cmp    $0x3000,%r11
    ...
    1350:	49 81 c4 00 00 30 00 	add    $0x300000,%r12
    1357:	49 81 c1 00 00 30 00 	add    $0x300000,%r9
    135e:	49 89 f6             	mov    %rsi,%r14
    1361:	48 81 fe 00 30 00 00 	cmp    $0x3000,%rsi
    ...
    13ef:	ba 00 30 00 00       	mov    $0x3000,%edx
    ...
    1465:	49 81 c7 00 80 01 00 	add    $0x18000,%r15
    146c:	e8 ef fb ff ff       	call   1060 <fputc@plt>
    1471:	49 81 ff 00 00 dc 05 	cmp    $0x5dc0000,%r15

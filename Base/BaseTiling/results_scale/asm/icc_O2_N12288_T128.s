...
results_scale/bin/icc_O2_N12288_T128:     file format elf64-x86-64
...
00000000004012a0 <main>:
  ...
  401488:	41 81 f8 00 30 00 00 	cmp    $0x3000,%r8d
  ...
  401500:	81 f9 00 30 00 00    	cmp    $0x3000,%ecx
  ...
  4017a2:	48 81 c6 00 80 01 00 	add    $0x18000,%rsi
  ...
  4017cd:	48 81 c1 00 80 01 00 	add    $0x18000,%rcx
  4017d4:	48 81 c3 00 80 01 00 	add    $0x18000,%rbx
  ...
  4017f0:	00 
  4017f1:	41 ba 00 30 00 00    	mov    $0x3000,%r10d
  ...
  401823:	40 80 ff 60          	cmp    $0x60,%dil
  ...
  401857:	49 81 c4 00 00 c0 00 	add    $0xc00000,%r12
  40185e:	41 81 c3 80 00 00 00 	add    $0x80,%r11d
  401865:	80 fb 60             	cmp    $0x60,%bl
  ...
  401920:	ba 00 30 00 00       	mov    $0x3000,%edx
  ...
  4019a1:	49 81 c4 00 80 01 00 	add    $0x18000,%r12

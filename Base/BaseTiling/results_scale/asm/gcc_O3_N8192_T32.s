...
results_scale/bin/gcc_O3_N8192_T32:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    12e0:	49 81 c1 00 00 01 00 	add    $0x10000,%r9
    12e7:	4d 39 fb             	cmp    %r15,%r11
    12ea:	75 c4                	jne    12b0 <main+0x200>
    12ec:	48 81 c1 00 00 01 00 	add    $0x10000,%rcx
    12f3:	49 81 c3 00 00 01 00 	add    $0x10000,%r11
    ...
    131f:	48 3d 00 20 00 00    	cmp    $0x2000,%rax
    ...
    133c:	48 81 ff 00 20 00 00 	cmp    $0x2000,%rdi
    ...
    1388:	48 81 fe 00 00 01 00 	cmp    $0x10000,%rsi
    ...
    13ab:	48 81 fe 00 20 00 00 	cmp    $0x2000,%rsi
    ...
    1439:	ba 00 20 00 00       	mov    $0x2000,%edx
    ...
    14af:	49 81 c6 00 00 01 00 	add    $0x10000,%r14
    14b6:	e8 a5 fb ff ff       	call   1060 <fputc@plt>
    14bb:	49 81 fe 00 00 e8 03 	cmp    $0x3e80000,%r14

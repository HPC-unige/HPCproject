...
results_scale/bin/gcc_O3_N10240_T128:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    123a:	48 8d 04 b6          	lea    (%rsi,%rsi,4),%rax
    ...
    12f0:	49 81 c1 00 40 01 00 	add    $0x14000,%r9
    12f7:	4d 39 e2             	cmp    %r12,%r10
    12fa:	75 c4                	jne    12c0 <main+0x210>
    12fc:	48 81 c1 00 40 01 00 	add    $0x14000,%rcx
    1303:	49 81 c2 00 40 01 00 	add    $0x14000,%r10
    ...
    132f:	48 3d 00 28 00 00    	cmp    $0x2800,%rax
    ...
    134c:	49 81 c6 00 00 a0 00 	add    $0xa00000,%r14
    1353:	48 81 ff 00 28 00 00 	cmp    $0x2800,%rdi
    ...
    13a0:	48 81 fe 00 40 01 00 	cmp    $0x14000,%rsi
    13a7:	75 e1                	jne    138a <main+0x2da>
    13a9:	e9 2f fe ff ff       	jmp    11dd <main+0x12d>
    13ae:	48 8d b0 80 00 00 00 	lea    0x80(%rax),%rsi
    13b5:	49 81 c0 00 00 a0 00 	add    $0xa00000,%r8
    13bc:	48 81 c1 00 00 a0 00 	add    $0xa00000,%rcx
    13c3:	48 89 f0             	mov    %rsi,%rax
    13c6:	48 81 fe 00 28 00 00 	cmp    $0x2800,%rsi
    ...
    1454:	ba 00 28 00 00       	mov    $0x2800,%edx
    ...
    14ca:	49 81 c6 00 40 01 00 	add    $0x14000,%r14
    14d1:	e8 8a fb ff ff       	call   1060 <fputc@plt>
    14d6:	49 81 fe 00 00 e2 04 	cmp    $0x4e20000,%r14

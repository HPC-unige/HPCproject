...
results_scale/bin/gcc_O2_N1024_T32:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    110d:	ba 00 00 80 00       	mov    $0x800000,%edx
    ...
    1124:	ba 00 00 80 00       	mov    $0x800000,%edx
    ...
    1198:	48 81 fa 00 20 00 00 	cmp    $0x2000,%rdx
    119f:	75 df                	jne    1180 <main+0xd0>
    11a1:	48 05 00 20 00 00    	add    $0x2000,%rax
    11a7:	48 3d 00 00 80 00    	cmp    $0x800000,%rax
    ...
    1242:	45 8d 58 20          	lea    0x20(%r8),%r11d
    ...
    128b:	4d 8d b2 00 ff ff ff 	lea    -0x100(%r10),%r14
    ...
    12c3:	48 3d 00 01 00 00    	cmp    $0x100,%rax
    12c9:	75 e5                	jne    12b0 <main+0x200>
    12cb:	49 83 c6 08          	add    $0x8,%r14
    12cf:	48 81 c7 00 20 00 00 	add    $0x2000,%rdi
    12d6:	4d 39 d6             	cmp    %r10,%r14
    12d9:	75 c5                	jne    12a0 <main+0x1f0>
    12db:	48 81 c6 00 20 00 00 	add    $0x2000,%rsi
    12e2:	49 81 c2 00 20 00 00 	add    $0x2000,%r10
    ...
    12fb:	49 83 c0 20          	add    $0x20,%r8
    12ff:	48 81 45 88 00 01 00 	addq   $0x100,-0x78(%rbp)
    1306:	00 
    1307:	49 81 f8 00 04 00 00 	cmp    $0x400,%r8
    ...
    1328:	49 81 fa 00 04 00 00 	cmp    $0x400,%r10
    132f:	48 8b 8d 58 ff ff ff 	mov    -0xa8(%rbp),%rcx
    1336:	4d 89 d5             	mov    %r10,%r13
    1339:	0f 85 bd fe ff ff    	jne    11fc <main+0x14c>
    133f:	48 81 c1 00 00 04 00 	add    $0x40000,%rcx
    1346:	49 81 c1 00 00 04 00 	add    $0x40000,%r9
    134d:	89 f3                	mov    %esi,%ebx
    134f:	49 89 d6             	mov    %rdx,%r14
    1352:	48 81 fa 00 04 00 00 	cmp    $0x400,%rdx
    ...
    13e0:	ba 00 04 00 00       	mov    $0x400,%edx
    ...
    1456:	49 81 c7 00 20 00 00 	add    $0x2000,%r15
    145d:	e8 fe fb ff ff       	call   1060 <fputc@plt>
    1462:	49 81 ff 00 00 7d 00 	cmp    $0x7d0000,%r15

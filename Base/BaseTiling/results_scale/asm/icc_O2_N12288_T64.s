...
results_scale/bin/icc_O2_N12288_T64:     file format elf64-x86-64
...
00000000004012a0 <main>:
  ...
  4014a8:	48 c1 e6 15          	shl    $0x15,%rsi
  ...
  4014f2:	41 8d 44 24 40       	lea    0x40(%r12),%eax
  4014f7:	3d 00 30 00 00       	cmp    $0x3000,%eax
  ...
  401554:	45 8d 60 40          	lea    0x40(%r8),%r12d
  401558:	41 81 fc 00 30 00 00 	cmp    $0x3000,%r12d
  40155f:	48 8b 8c 24 a8 00 00 	mov    0xa8(%rsp),%rcx
  401566:	00 
  401567:	45 0f 4d e2          	cmovge %r10d,%r12d
  40156b:	33 db                	xor    %ebx,%ebx
  40156d:	48 c1 e1 0f          	shl    $0xf,%rcx
  ...
  401586:	49 c1 e7 09          	shl    $0x9,%r15
  ...
  401794:	48 81 c6 00 80 01 00 	add    $0x18000,%rsi
  ...
  4017c6:	48 81 c3 00 80 01 00 	add    $0x18000,%rbx
  ...
  4017e2:	41 ba 00 30 00 00    	mov    $0x3000,%r10d
  ...
  401809:	83 c7 c0             	add    $0xffffffc0,%edi
  40180c:	41 83 c0 40          	add    $0x40,%r8d
  ...
  401833:	48 83 c1 40          	add    $0x40,%rcx
  401837:	4c 8b 6c 24 68       	mov    0x68(%rsp),%r13
  40183c:	49 83 c6 c0          	add    $0xffffffffffffffc0,%r14
  401840:	44 8b 64 24 70       	mov    0x70(%rsp),%r12d
  401845:	49 81 c5 00 00 60 00 	add    $0x600000,%r13
  40184c:	41 83 c4 40          	add    $0x40,%r12d
  ...
  40190c:	ba 00 30 00 00       	mov    $0x3000,%edx
  ...
  40198d:	49 81 c4 00 80 01 00 	add    $0x18000,%r12

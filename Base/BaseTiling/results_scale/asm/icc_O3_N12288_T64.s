...
results_scale/bin/icc_O3_N12288_T64:     file format elf64-x86-64
...
00000000004012a0 <main>:
  ...
  40147b:	44 8d 4a 40          	lea    0x40(%rdx),%r9d
  ...
  401496:	48 c1 e6 06          	shl    $0x6,%rsi
  ...
  4014aa:	48 c1 e7 15          	shl    $0x15,%rdi
  ...
  4014f4:	41 8d 44 24 40       	lea    0x40(%r12),%eax
  ...
  401556:	45 8d 60 40          	lea    0x40(%r8),%r12d
  ...
  401588:	49 c1 e7 09          	shl    $0x9,%r15
  ...
  40180b:	83 c7 c0             	add    $0xffffffc0,%edi
  40180e:	41 83 c0 40          	add    $0x40,%r8d
  401812:	81 fe c0 00 00 00    	cmp    $0xc0,%esi
  ...
  401835:	48 83 c1 40          	add    $0x40,%rcx
  401839:	4c 8b 6c 24 68       	mov    0x68(%rsp),%r13
  40183e:	49 83 c6 c0          	add    $0xffffffffffffffc0,%r14
  401842:	44 8b 64 24 70       	mov    0x70(%rsp),%r12d
  401847:	49 81 c5 00 00 60 00 	add    $0x600000,%r13
  40184e:	41 83 c4 40          	add    $0x40,%r12d
  401852:	41 81 fb c0 00 00 00 	cmp    $0xc0,%r11d
  ...
  401869:	83 c2 40             	add    $0x40,%edx
  40186c:	3d c0 00 00 00       	cmp    $0xc0,%eax

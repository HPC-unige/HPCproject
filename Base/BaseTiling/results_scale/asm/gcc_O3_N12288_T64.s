...
results_scale/bin/gcc_O3_N12288_T64:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    10b9:	ba 00 00 00 48       	mov    $0x48000000,%edx
    ...
    1107:	ba 00 00 00 48       	mov    $0x48000000,%edx
    ...
    111e:	ba 00 00 00 48       	mov    $0x48000000,%edx
    ...
    1174:	00 
    1175:	48 8d bf 08 00 00 48 	lea    0x48000008(%rdi),%rdi
    ...
    11d4:	48 81 fe 00 80 01 00 	cmp    $0x18000,%rsi
    11db:	75 e4                	jne    11c1 <main+0x111>
    11dd:	49 81 c0 00 80 01 00 	add    $0x18000,%r8
    11e4:	48 81 c1 00 80 01 00 	add    $0x18000,%rcx
    11eb:	48 05 00 80 01 00    	add    $0x18000,%rax
    11f1:	48 81 c2 00 80 01 00 	add    $0x18000,%rdx
    ...
    126a:	8d 48 40             	lea    0x40(%rax),%ecx
    ...
    12a0:	4d 8d a2 00 fe ff ff 	lea    -0x200(%r10),%r12
    ...
    12e0:	49 81 c1 00 80 01 00 	add    $0x18000,%r9
    12e7:	4d 39 e2             	cmp    %r12,%r10
    12ea:	75 c4                	jne    12b0 <main+0x200>
    12ec:	48 81 c1 00 80 01 00 	add    $0x18000,%rcx
    12f3:	49 81 c2 00 80 01 00 	add    $0x18000,%r10
    ...
    131f:	48 3d 00 30 00 00    	cmp    $0x3000,%rax
    ...
    133c:	49 81 c6 00 00 60 00 	add    $0x600000,%r14
    1343:	48 81 ff 00 30 00 00 	cmp    $0x3000,%rdi
    ...
    1390:	48 81 fe 00 80 01 00 	cmp    $0x18000,%rsi
    1397:	75 e1                	jne    137a <main+0x2ca>
    1399:	e9 3f fe ff ff       	jmp    11dd <main+0x12d>
    139e:	48 8d 70 40          	lea    0x40(%rax),%rsi
    13a2:	49 81 c0 00 00 60 00 	add    $0x600000,%r8
    13a9:	48 81 c1 00 00 60 00 	add    $0x600000,%rcx
    13b0:	48 89 f0             	mov    %rsi,%rax
    13b3:	48 81 fe 00 30 00 00 	cmp    $0x3000,%rsi
    ...
    1441:	ba 00 30 00 00       	mov    $0x3000,%edx
    ...
    14b7:	49 81 c6 00 80 01 00 	add    $0x18000,%r14
    14be:	e8 9d fb ff ff       	call   1060 <fputc@plt>
    14c3:	49 81 fe 00 00 dc 05 	cmp    $0x5dc0000,%r14

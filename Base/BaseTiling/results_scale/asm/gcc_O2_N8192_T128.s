...
results_scale/bin/gcc_O2_N8192_T128:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    11d4:	41 8d 85 80 00 00 00 	lea    0x80(%r13),%eax
    11db:	49 89 f7             	mov    %rsi,%r15
    11de:	45 31 d2             	xor    %r10d,%r10d
    11e1:	89 d9                	mov    %ebx,%ecx
    11e3:	89 45 84             	mov    %eax,-0x7c(%rbp)
    11e6:	49 8d 85 80 00 00 00 	lea    0x80(%r13),%rax
    11ed:	48 89 c2             	mov    %rax,%rdx
    11f0:	48 c1 e2 0d          	shl    $0xd,%rdx
    11f4:	48 89 95 70 ff ff ff 	mov    %rdx,-0x90(%rbp)
    11fb:	48 89 c2             	mov    %rax,%rdx
    11fe:	4c 89 f0             	mov    %r14,%rax
    1201:	4d 8d 9a 80 00 00 00 	lea    0x80(%r10),%r11
    1208:	4c 89 65 88          	mov    %r12,-0x78(%rbp)
    120c:	41 8d 9a 80 00 00 00 	lea    0x80(%r10),%ebx
    1213:	45 31 c0             	xor    %r8d,%r8d
    1216:	4c 89 a5 60 ff ff ff 	mov    %r12,-0xa0(%rbp)
    121d:	4b 8d 3c d9          	lea    (%r9,%r11,8),%rdi
    1221:	4c 89 8d 58 ff ff ff 	mov    %r9,-0xa8(%rbp)
    1228:	48 89 bd 78 ff ff ff 	mov    %rdi,-0x88(%rbp)
    122f:	4c 89 df             	mov    %r11,%rdi
    1232:	48 89 b5 68 ff ff ff 	mov    %rsi,-0x98(%rbp)
    1239:	89 ce                	mov    %ecx,%esi
    123b:	44 39 6d 84          	cmp    %r13d,-0x7c(%rbp)
    123f:	45 8d 98 80 00 00 00 	lea    0x80(%r8),%r11d
    1246:	0f 8e a9 00 00 00    	jle    12f5 <main+0x245>
    124c:	48 8b 8d 70 ff ff ff 	mov    -0x90(%rbp),%rcx
    1253:	4c 89 bd 50 ff ff ff 	mov    %r15,-0xb0(%rbp)
    125a:	4f 8d 34 c7          	lea    (%r15,%r8,8),%r14
    125e:	48 89 85 48 ff ff ff 	mov    %rax,-0xb8(%rbp)
    1265:	4c 8b 8d 78 ff ff ff 	mov    -0x88(%rbp),%r9
    126c:	4c 01 c1             	add    %r8,%rcx
    126f:	4c 89 ad 40 ff ff ff 	mov    %r13,-0xc0(%rbp)
    1276:	4c 8d 24 c8          	lea    (%rax,%rcx,8),%r12
    127a:	48 8b 4d 88          	mov    -0x78(%rbp),%rcx
    127e:	66 90                	xchg   %ax,%ax
    1280:	44 39 d3             	cmp    %r10d,%ebx
    1283:	4d 8d b9 00 fc ff ff 	lea    -0x400(%r9),%r15
    128a:	4d 89 f5             	mov    %r14,%r13
    128d:	7e 3e                	jle    12cd <main+0x21d>
    128f:	90                   	nop
    1290:	31 c0                	xor    %eax,%eax
    1292:	45 39 c3             	cmp    %r8d,%r11d
    1295:	c4 c2 7d 19 0f       	vbroadcastsd (%r15),%ymm1
    129a:	7e 21                	jle    12bd <main+0x20d>
    129c:	0f 1f 40 00          	nopl   0x0(%rax)
    12a0:	c4 c1 75 59 44 05 00 	vmulpd 0x0(%r13,%rax,1),%ymm1,%ymm0
    12a7:	c5 fd 58 04 01       	vaddpd (%rcx,%rax,1),%ymm0,%ymm0
    12ac:	c5 fd 11 04 01       	vmovupd %ymm0,(%rcx,%rax,1)
    12b1:	48 83 c0 20          	add    $0x20,%rax
    12b5:	48 3d 00 04 00 00    	cmp    $0x400,%rax
    12bb:	75 e3                	jne    12a0 <main+0x1f0>
    12bd:	49 83 c7 08          	add    $0x8,%r15
    12c1:	49 81 c5 00 00 01 00 	add    $0x10000,%r13
    12c8:	4d 39 cf             	cmp    %r9,%r15
    12cb:	75 c3                	jne    1290 <main+0x1e0>
    12cd:	48 81 c1 00 00 01 00 	add    $0x10000,%rcx
    12d4:	49 81 c1 00 00 01 00 	add    $0x10000,%r9
    12db:	4c 39 e1             	cmp    %r12,%rcx
    12de:	75 a0                	jne    1280 <main+0x1d0>
    12e0:	4c 8b bd 50 ff ff ff 	mov    -0xb0(%rbp),%r15
    12e7:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
    12ee:	4c 8b ad 40 ff ff ff 	mov    -0xc0(%rbp),%r13
    12f5:	49 83 e8 80          	sub    $0xffffffffffffff80,%r8
    12f9:	48 81 45 88 00 04 00 	addq   $0x400,-0x78(%rbp)
    1300:	00 
    1301:	49 81 f8 00 20 00 00 	cmp    $0x2000,%r8
    1308:	0f 85 2d ff ff ff    	jne    123b <main+0x18b>
    130e:	49 81 c7 00 00 80 00 	add    $0x800000,%r15
    1315:	48 81 ff 00 20 00 00 	cmp    $0x2000,%rdi
    131c:	89 f1                	mov    %esi,%ecx
    131e:	4c 8b a5 60 ff ff ff 	mov    -0xa0(%rbp),%r12
    1325:	4c 8b 8d 58 ff ff ff 	mov    -0xa8(%rbp),%r9
    132c:	48 8b b5 68 ff ff ff 	mov    -0x98(%rbp),%rsi
    1333:	49 89 fa             	mov    %rdi,%r10
    1336:	0f 85 c5 fe ff ff    	jne    1201 <main+0x151>
    133c:	49 81 c4 00 00 80 00 	add    $0x800000,%r12
    1343:	49 89 c6             	mov    %rax,%r14
    1346:	89 cb                	mov    %ecx,%ebx
    1348:	49 89 d5             	mov    %rdx,%r13
    134b:	49 81 c1 00 00 80 00 	add    $0x800000,%r9
    1352:	48 81 fa 00 20 00 00 	cmp    $0x2000,%rdx
    1359:	0f 85 75 fe ff ff    	jne    11d4 <main+0x124>
    ...
    13e0:	ba 00 20 00 00       	mov    $0x2000,%edx
    ...
    1456:	49 81 c7 00 00 01 00 	add    $0x10000,%r15
    145d:	e8 fe fb ff ff       	call   1060 <fputc@plt>
    1462:	49 81 ff 00 00 e8 03 	cmp    $0x3e80000,%r15

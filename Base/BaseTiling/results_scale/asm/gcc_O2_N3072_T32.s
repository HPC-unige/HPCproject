...
results_scale/bin/gcc_O2_N3072_T32:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    12c2:	49 81 c5 00 60 00 00 	add    $0x6000,%r13
    12c9:	4d 39 c6             	cmp    %r8,%r14
    12cc:	75 c2                	jne    1290 <main+0x1e0>
    12ce:	49 81 c0 00 60 00 00 	add    $0x6000,%r8
    12d5:	48 81 c2 00 60 00 00 	add    $0x6000,%rdx
    ...
    1350:	49 81 c4 00 00 0c 00 	add    $0xc0000,%r12
    1357:	49 81 c1 00 00 0c 00 	add    $0xc0000,%r9
    135e:	49 89 f6             	mov    %rsi,%r14
    1361:	48 81 fe 00 0c 00 00 	cmp    $0xc00,%rsi
    ...
    13ef:	ba 00 0c 00 00       	mov    $0xc00,%edx
    ...
    1465:	49 81 c7 00 60 00 00 	add    $0x6000,%r15
    146c:	e8 ef fb ff ff       	call   1060 <fputc@plt>
    1471:	49 81 ff 00 00 77 01 	cmp    $0x1770000,%r15

...
results_scale/bin/icx_O2_N10240_T32:     file format elf64-x86-64
...
0000000000401550 <main>:
  ...
  401747:	48 c1 e2 10          	shl    $0x10,%rdx
  ...
  401763:	49 c1 e2 05          	shl    $0x5,%r10
  ...
  401878:	49 83 fc 1f          	cmp    $0x1f,%r12
  40187c:	49 89 d4             	mov    %rdx,%r12
  40187f:	0f 85 0b ff ff ff    	jne    401790 <main+0x240>
  401885:	49 8d 56 01          	lea    0x1(%r14),%rdx
  401889:	48 81 c3 00 01 00 00 	add    $0x100,%rbx
  401890:	49 81 c3 00 01 00 00 	add    $0x100,%r11
  401897:	49 81 fe 3f 01 00 00 	cmp    $0x13f,%r14
  40189e:	49 89 d6             	mov    %rdx,%r14
  4018a1:	0f 85 d9 fe ff ff    	jne    401780 <main+0x230>
  4018a7:	41 8d 51 01          	lea    0x1(%r9),%edx
  4018ab:	49 81 c0 00 00 28 00 	add    $0x280000,%r8
  4018b2:	41 81 f9 3f 01 00 00 	cmp    $0x13f,%r9d
  ...
  4018ca:	48 81 c1 00 00 28 00 	add    $0x280000,%rcx
  4018d1:	81 fe 3f 01 00 00    	cmp    $0x13f,%esi

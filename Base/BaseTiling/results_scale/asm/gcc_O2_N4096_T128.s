...
results_scale/bin/gcc_O2_N4096_T128:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    110d:	ba 00 00 00 08       	mov    $0x8000000,%edx
    ...
    1124:	ba 00 00 00 08       	mov    $0x8000000,%edx
    ...
    1198:	48 81 fa 00 80 00 00 	cmp    $0x8000,%rdx
    119f:	75 df                	jne    1180 <main+0xd0>
    11a1:	48 05 00 80 00 00    	add    $0x8000,%rax
    11a7:	48 3d 00 00 00 08    	cmp    $0x8000000,%rax
    ...
    11db:	49 8d 86 80 00 00 00 	lea    0x80(%r14),%rax
    11e2:	45 8d be 80 00 00 00 	lea    0x80(%r14),%r15d
    11e9:	45 31 ed             	xor    %r13d,%r13d
    11ec:	89 de                	mov    %ebx,%esi
    11ee:	48 89 c2             	mov    %rax,%rdx
    11f1:	48 c1 e2 0c          	shl    $0xc,%rdx
    11f5:	48 89 95 78 ff ff ff 	mov    %rdx,-0x88(%rbp)
    11fc:	48 89 c2             	mov    %rax,%rdx
    11ff:	44 89 f8             	mov    %r15d,%eax
    1202:	4d 8d 95 80 00 00 00 	lea    0x80(%r13),%r10
    1209:	48 89 4d 88          	mov    %rcx,-0x78(%rbp)
    120d:	41 8d 9d 80 00 00 00 	lea    0x80(%r13),%ebx
    1214:	45 31 c0             	xor    %r8d,%r8d
    1217:	4b 8d 3c d1          	lea    (%r9,%r10,8),%rdi
    121b:	4c 89 9d 60 ff ff ff 	mov    %r11,-0xa0(%rbp)
    1222:	48 89 7d 80          	mov    %rdi,-0x80(%rbp)
    1226:	4c 89 ef             	mov    %r13,%rdi
    1229:	48 c1 e7 0f          	shl    $0xf,%rdi
    122d:	48 89 8d 58 ff ff ff 	mov    %rcx,-0xa8(%rbp)
    1234:	4c 89 d1             	mov    %r10,%rcx
    1237:	4c 01 df             	add    %r11,%rdi
    123a:	4c 89 8d 50 ff ff ff 	mov    %r9,-0xb0(%rbp)
    1241:	41 89 f1             	mov    %esi,%r9d
    1244:	48 89 bd 70 ff ff ff 	mov    %rdi,-0x90(%rbp)
    124b:	44 39 f0             	cmp    %r14d,%eax
    124e:	45 8d 98 80 00 00 00 	lea    0x80(%r8),%r11d
    1255:	0f 8e b0 00 00 00    	jle    130b <main+0x25b>
    125b:	48 8b bd 70 ff ff ff 	mov    -0x90(%rbp),%rdi
    1262:	4c 8b 55 80          	mov    -0x80(%rbp),%r10
    1266:	89 85 4c ff ff ff    	mov    %eax,-0xb4(%rbp)
    126c:	4c 89 b5 40 ff ff ff 	mov    %r14,-0xc0(%rbp)
    1273:	4e 8d 3c c7          	lea    (%rdi,%r8,8),%r15
    1277:	48 8b bd 78 ff ff ff 	mov    -0x88(%rbp),%rdi
    127e:	4a 8d 34 07          	lea    (%rdi,%r8,1),%rsi
    1282:	48 8b bd 68 ff ff ff 	mov    -0x98(%rbp),%rdi
    1289:	4c 8d 24 f7          	lea    (%rdi,%rsi,8),%r12
    128d:	48 8b 75 88          	mov    -0x78(%rbp),%rsi
    1291:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1298:	44 39 eb             	cmp    %r13d,%ebx
    129b:	4d 8d b2 00 fc ff ff 	lea    -0x400(%r10),%r14
    12a2:	4c 89 ff             	mov    %r15,%rdi
    12a5:	7e 44                	jle    12eb <main+0x23b>
    12a7:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    12ae:	00 00 
    12b0:	31 c0                	xor    %eax,%eax
    12b2:	45 39 c3             	cmp    %r8d,%r11d
    ...
    12c5:	c5 fd 58 04 06       	vaddpd (%rsi,%rax,1),%ymm0,%ymm0
    12ca:	c5 fd 11 04 06       	vmovupd %ymm0,(%rsi,%rax,1)
    ...
    12df:	48 81 c7 00 80 00 00 	add    $0x8000,%rdi
    12e6:	4d 39 d6             	cmp    %r10,%r14
    12e9:	75 c5                	jne    12b0 <main+0x200>
    12eb:	48 81 c6 00 80 00 00 	add    $0x8000,%rsi
    12f2:	49 81 c2 00 80 00 00 	add    $0x8000,%r10
    12f9:	4c 39 e6             	cmp    %r12,%rsi
    12fc:	75 9a                	jne    1298 <main+0x1e8>
    ...
    1316:	00 
    1317:	49 81 f8 00 10 00 00 	cmp    $0x1000,%r8
    131e:	0f 85 27 ff ff ff    	jne    124b <main+0x19b>
    1324:	49 89 ca             	mov    %rcx,%r10
    1327:	44 89 ce             	mov    %r9d,%esi
    132a:	4c 8b 9d 60 ff ff ff 	mov    -0xa0(%rbp),%r11
    1331:	4c 8b 8d 50 ff ff ff 	mov    -0xb0(%rbp),%r9
    1338:	49 81 fa 00 10 00 00 	cmp    $0x1000,%r10
    133f:	48 8b 8d 58 ff ff ff 	mov    -0xa8(%rbp),%rcx
    1346:	4d 89 d5             	mov    %r10,%r13
    1349:	0f 85 b3 fe ff ff    	jne    1202 <main+0x152>
    134f:	48 81 c1 00 00 40 00 	add    $0x400000,%rcx
    1356:	49 81 c1 00 00 40 00 	add    $0x400000,%r9
    135d:	89 f3                	mov    %esi,%ebx
    135f:	49 89 d6             	mov    %rdx,%r14
    1362:	48 81 fa 00 10 00 00 	cmp    $0x1000,%rdx
    1369:	0f 85 6c fe ff ff    	jne    11db <main+0x12b>
    136f:	48 8d 75 c0          	lea    -0x40(%rbp),%rsi
    ...
    13f0:	ba 00 10 00 00       	mov    $0x1000,%edx
    ...
    1466:	49 81 c7 00 80 00 00 	add    $0x8000,%r15
    146d:	e8 ee fb ff ff       	call   1060 <fputc@plt>
    1472:	49 81 ff 00 00 f4 01 	cmp    $0x1f40000,%r15

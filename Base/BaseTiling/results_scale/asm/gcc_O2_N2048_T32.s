...
results_scale/bin/gcc_O2_N2048_T32:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    12b1:	49 81 c5 00 40 00 00 	add    $0x4000,%r13
    12b8:	4d 39 cf             	cmp    %r9,%r15
    12bb:	75 c3                	jne    1280 <main+0x1d0>
    12bd:	48 81 c1 00 40 00 00 	add    $0x4000,%rcx
    12c4:	49 81 c1 00 40 00 00 	add    $0x4000,%r9
    ...
    12f0:	00 
    12f1:	49 81 f8 00 08 00 00 	cmp    $0x800,%r8
    12f8:	0f 85 31 ff ff ff    	jne    122f <main+0x17f>
    12fe:	49 81 c7 00 00 08 00 	add    $0x80000,%r15
    1305:	48 81 ff 00 08 00 00 	cmp    $0x800,%rdi
    ...
    132c:	49 81 c4 00 00 08 00 	add    $0x80000,%r12
    1333:	49 89 c6             	mov    %rax,%r14
    1336:	89 cb                	mov    %ecx,%ebx
    1338:	49 89 d5             	mov    %rdx,%r13
    133b:	49 81 c1 00 00 08 00 	add    $0x80000,%r9
    1342:	48 81 fa 00 08 00 00 	cmp    $0x800,%rdx
    ...
    13d0:	ba 00 08 00 00       	mov    $0x800,%edx
    ...
    1446:	49 81 c7 00 40 00 00 	add    $0x4000,%r15
    144d:	e8 0e fc ff ff       	call   1060 <fputc@plt>
    1452:	49 81 ff 00 00 fa 00 	cmp    $0xfa0000,%r15

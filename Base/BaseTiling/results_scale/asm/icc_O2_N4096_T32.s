...
results_scale/bin/icc_O2_N4096_T32:     file format elf64-x86-64
...
00000000004012a0 <main>:
  ...
  401459:	41 ba 00 10 00 00    	mov    $0x1000,%r10d
  ...
  40147e:	8d 7a 20             	lea    0x20(%rdx),%edi
  401481:	4d 89 cf             	mov    %r9,%r15
  401484:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
  ...
  401499:	49 c1 e7 14          	shl    $0x14,%r15
  40149d:	45 33 f6             	xor    %r14d,%r14d
  4014a0:	49 c1 e1 05          	shl    $0x5,%r9
  ...
  4014ed:	41 8d 44 24 20       	lea    0x20(%r12),%eax
  4014f2:	3d 00 10 00 00       	cmp    $0x1000,%eax
  ...
  40154f:	45 8d 60 20          	lea    0x20(%r8),%r12d
  401553:	41 81 fc 00 10 00 00 	cmp    $0x1000,%r12d
  ...
  40157d:	49 c1 e7 08          	shl    $0x8,%r15
  ...
  4015ce:	4c 8b 8c 24 10 01 00 	mov    0x110(%rsp),%r9
  4015d5:	00 
  4015d6:	33 ff                	xor    %edi,%edi
  4015d8:	4c 8b 84 24 08 01 00 	mov    0x108(%rsp),%r8
  4015df:	00 
  4015e0:	48 8b b4 24 f8 00 00 	mov    0xf8(%rsp),%rsi
  4015e7:	00 
  4015e8:	4c 3b 8c 24 00 01 00 	cmp    0x100(%rsp),%r9
  4015ef:	00 
  ...
  40178b:	48 81 c6 00 80 00 00 	add    $0x8000,%rsi
  ...
  4017b6:	48 81 c1 00 80 00 00 	add    $0x8000,%rcx
  4017bd:	48 81 c3 00 80 00 00 	add    $0x8000,%rbx
  ...
  4017d9:	41 ba 00 10 00 00    	mov    $0x1000,%r10d
  ...
  401800:	83 c7 e0             	add    $0xffffffe0,%edi
  401803:	41 83 c0 20          	add    $0x20,%r8d
  ...
  40182a:	48 83 c1 20          	add    $0x20,%rcx
  40182e:	4c 8b 6c 24 68       	mov    0x68(%rsp),%r13
  401833:	49 83 c6 e0          	add    $0xffffffffffffffe0,%r14
  401837:	44 8b 64 24 70       	mov    0x70(%rsp),%r12d
  40183c:	49 81 c5 00 00 10 00 	add    $0x100000,%r13
  401843:	41 83 c4 20          	add    $0x20,%r12d
  ...
  401903:	ba 00 10 00 00       	mov    $0x1000,%edx
  ...
  401984:	49 81 c4 00 80 00 00 	add    $0x8000,%r12

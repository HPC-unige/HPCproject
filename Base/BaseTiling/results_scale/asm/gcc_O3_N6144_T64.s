...
results_scale/bin/gcc_O3_N6144_T64:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    12e0:	49 81 c1 00 c0 00 00 	add    $0xc000,%r9
    12e7:	4d 39 e2             	cmp    %r12,%r10
    12ea:	75 c4                	jne    12b0 <main+0x200>
    12ec:	48 81 c1 00 c0 00 00 	add    $0xc000,%rcx
    12f3:	49 81 c2 00 c0 00 00 	add    $0xc000,%r10
    ...
    131f:	48 3d 00 18 00 00    	cmp    $0x1800,%rax
    ...
    1343:	48 81 ff 00 18 00 00 	cmp    $0x1800,%rdi
    ...
    1390:	48 81 fe 00 c0 00 00 	cmp    $0xc000,%rsi
    ...
    13b3:	48 81 fe 00 18 00 00 	cmp    $0x1800,%rsi
    ...
    1441:	ba 00 18 00 00       	mov    $0x1800,%edx
    ...
    14b7:	49 81 c6 00 c0 00 00 	add    $0xc000,%r14
    14be:	e8 9d fb ff ff       	call   1060 <fputc@plt>
    14c3:	49 81 fe 00 00 ee 02 	cmp    $0x2ee0000,%r14

...
results_scale/bin/gcc_O2_N6144_T32:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    110d:	ba 00 00 00 12       	mov    $0x12000000,%edx
    ...
    1124:	ba 00 00 00 12       	mov    $0x12000000,%edx
    ...
    1198:	48 81 fa 00 c0 00 00 	cmp    $0xc000,%rdx
    119f:	75 df                	jne    1180 <main+0xd0>
    11a1:	48 05 00 c0 00 00    	add    $0xc000,%rax
    11a7:	48 3d 00 00 00 12    	cmp    $0x12000000,%rax
    ...
    12c2:	49 81 c5 00 c0 00 00 	add    $0xc000,%r13
    12c9:	4d 39 c6             	cmp    %r8,%r14
    12cc:	75 c2                	jne    1290 <main+0x1e0>
    12ce:	49 81 c0 00 c0 00 00 	add    $0xc000,%r8
    12d5:	48 81 c2 00 c0 00 00 	add    $0xc000,%rdx
    ...
    1350:	49 81 c4 00 00 18 00 	add    $0x180000,%r12
    1357:	49 81 c1 00 00 18 00 	add    $0x180000,%r9
    135e:	49 89 f6             	mov    %rsi,%r14
    1361:	48 81 fe 00 18 00 00 	cmp    $0x1800,%rsi
    ...
    13ef:	ba 00 18 00 00       	mov    $0x1800,%edx
    ...
    1465:	49 81 c7 00 c0 00 00 	add    $0xc000,%r15
    146c:	e8 ef fb ff ff       	call   1060 <fputc@plt>
    1471:	49 81 ff 00 00 ee 02 	cmp    $0x2ee0000,%r15

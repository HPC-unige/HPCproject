...
results_scale/bin/gcc_O2_N12288_T128:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    12d2:	49 81 c5 00 80 01 00 	add    $0x18000,%r13
    12d9:	4d 39 c6             	cmp    %r8,%r14
    12dc:	75 c2                	jne    12a0 <main+0x1f0>
    12de:	49 81 c0 00 80 01 00 	add    $0x18000,%r8
    12e5:	48 81 c2 00 80 01 00 	add    $0x18000,%rdx
    ...
    1360:	49 81 c4 00 00 c0 00 	add    $0xc00000,%r12
    1367:	49 81 c1 00 00 c0 00 	add    $0xc00000,%r9
    136e:	49 89 f6             	mov    %rsi,%r14
    1371:	48 81 fe 00 30 00 00 	cmp    $0x3000,%rsi
    ...
    13ff:	ba 00 30 00 00       	mov    $0x3000,%edx
    ...
    1475:	49 81 c7 00 80 01 00 	add    $0x18000,%r15
    147c:	e8 df fb ff ff       	call   1060 <fputc@plt>
    1481:	49 81 ff 00 00 dc 05 	cmp    $0x5dc0000,%r15

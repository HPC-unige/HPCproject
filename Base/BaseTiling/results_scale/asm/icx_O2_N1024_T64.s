...
results_scale/bin/icx_O2_N1024_T64:     file format elf64-x86-64
...
0000000000401550 <main>:
  ...
  40157c:	ba 00 00 80 00       	mov    $0x800000,%edx
  ...
  401599:	ba 00 00 80 00       	mov    $0x800000,%edx
  ...
  4015b1:	ba 00 00 80 00       	mov    $0x800000,%edx
  ...
  401605:	5d                   	pop    %rbp
  401606:	c3                   	ret
  401607:	ba 00 00 80 00       	mov    $0x800000,%edx
  ...
  4016ca:	48 81 f9 fc ff 0f 00 	cmp    $0xffffc,%rcx
  ...
  4016f3:	ba 00 e0 00 00       	mov    $0xe000,%edx
  ...
  401733:	49 c1 e2 06          	shl    $0x6,%r10
  ...
  401763:	49 c1 e5 0a          	shl    $0xa,%r13
  ...
  4017c0:	c5 7d 10 84 f5 20 20 	vmovupd -0xdfe0(%rbp,%rsi,8),%ymm8
  4017c7:	ff ff 
  4017c9:	c4 42 fd a8 44 f7 20 	vfmadd213pd 0x20(%r15,%rsi,8),%ymm0,%ymm8
  4017d0:	c4 62 f5 b8 84 f5 20 	vfmadd231pd -0xbfe0(%rbp,%rsi,8),%ymm1,%ymm8
  4017d7:	40 ff ff 
  4017da:	c4 62 ed b8 84 f5 20 	vfmadd231pd -0x9fe0(%rbp,%rsi,8),%ymm2,%ymm8
  4017e1:	60 ff ff 
  4017e4:	c4 62 e5 b8 84 f5 20 	vfmadd231pd -0x7fe0(%rbp,%rsi,8),%ymm3,%ymm8
  4017eb:	80 ff ff 
  4017ee:	c4 62 dd b8 84 f5 20 	vfmadd231pd -0x5fe0(%rbp,%rsi,8),%ymm4,%ymm8
  4017f5:	a0 ff ff 
  4017f8:	c4 62 d5 b8 84 f5 20 	vfmadd231pd -0x3fe0(%rbp,%rsi,8),%ymm5,%ymm8
  4017ff:	c0 ff ff 
  401802:	c4 62 cd b8 84 f5 20 	vfmadd231pd -0x1fe0(%rbp,%rsi,8),%ymm6,%ymm8
  401809:	e0 ff ff 
  ...
  40181e:	48 83 fe 3c          	cmp    $0x3c,%rsi
  401822:	72 9c                	jb     4017c0 <main+0x270>
  401824:	48 8d 72 01          	lea    0x1(%rdx),%rsi
  401828:	48 81 c5 00 00 01 00 	add    $0x10000,%rbp
  40182f:	48 83 fa 07          	cmp    $0x7,%rdx
  401833:	48 89 f2             	mov    %rsi,%rdx
  401836:	0f 85 34 ff ff ff    	jne    401770 <main+0x220>
  40183c:	49 8d 54 24 01       	lea    0x1(%r12),%rdx
  401841:	49 81 c7 00 20 00 00 	add    $0x2000,%r15
  401848:	49 83 fc 3f          	cmp    $0x3f,%r12
  40184c:	49 89 d4             	mov    %rdx,%r12
  40184f:	0f 85 0b ff ff ff    	jne    401760 <main+0x210>
  401855:	49 8d 56 01          	lea    0x1(%r14),%rdx
  401859:	48 81 c3 00 02 00 00 	add    $0x200,%rbx
  401860:	49 81 c3 00 02 00 00 	add    $0x200,%r11
  401867:	49 83 fe 0f          	cmp    $0xf,%r14
  ...
  40187f:	41 83 f9 0f          	cmp    $0xf,%r9d
  ...
  401931:	ba 00 04 00 00       	mov    $0x400,%edx
  ...
  401b17:	49 81 c6 00 20 00 00 	add    $0x2000,%r14

...
results_scale/bin/gcc_O2_N2048_T128:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    110a:	ba 00 00 00 02       	mov    $0x2000000,%edx
    ...
    1121:	ba 00 00 00 02       	mov    $0x2000000,%edx
    ...
    1194:	48 3d 00 40 00 00    	cmp    $0x4000,%rax
    119a:	75 e2                	jne    117e <main+0xce>
    119c:	48 81 c2 00 40 00 00 	add    $0x4000,%rdx
    11a3:	48 81 fa 00 00 00 02 	cmp    $0x2000000,%rdx
    ...
    11cc:	45 8d b7 80 00 00 00 	lea    0x80(%r15),%r14d
    11d3:	45 31 ed             	xor    %r13d,%r13d
    11d6:	4c 89 c8             	mov    %r9,%rax
    11d9:	44 89 f7             	mov    %r14d,%edi
    11dc:	49 8d 95 80 00 00 00 	lea    0x80(%r13),%rdx
    11e3:	45 31 c9             	xor    %r9d,%r9d
    11e6:	49 89 c8             	mov    %rcx,%r8
    11e9:	4c 89 9d 70 ff ff ff 	mov    %r11,-0x90(%rbp)
    11f0:	48 8d 34 d1          	lea    (%rcx,%rdx,8),%rsi
    11f4:	48 89 85 68 ff ff ff 	mov    %rax,-0x98(%rbp)
    11fb:	41 8d 9d 80 00 00 00 	lea    0x80(%r13),%ebx
    1202:	48 89 75 88          	mov    %rsi,-0x78(%rbp)
    1206:	4c 89 ee             	mov    %r13,%rsi
    1209:	48 c1 e6 0e          	shl    $0xe,%rsi
    120d:	4c 01 de             	add    %r11,%rsi
    1210:	48 89 b5 78 ff ff ff 	mov    %rsi,-0x88(%rbp)
    1217:	48 89 c6             	mov    %rax,%rsi
    121a:	48 89 d0             	mov    %rdx,%rax
    121d:	44 39 ff             	cmp    %r15d,%edi
    1220:	45 8d 99 80 00 00 00 	lea    0x80(%r9),%r11d
    1227:	0f 8e 8c 00 00 00    	jle    12b9 <main+0x209>
    122d:	48 8b 95 78 ff ff ff 	mov    -0x88(%rbp),%rdx
    1234:	89 7d 80             	mov    %edi,-0x80(%rbp)
    1237:	4c 8d a6 00 00 20 00 	lea    0x200000(%rsi),%r12
    123e:	48 89 b5 60 ff ff ff 	mov    %rsi,-0xa0(%rbp)
    1245:	4c 8b 55 88          	mov    -0x78(%rbp),%r10
    1249:	4e 8d 34 ca          	lea    (%rdx,%r9,8),%r14
    124d:	48 89 f2             	mov    %rsi,%rdx
    1250:	44 39 eb             	cmp    %r13d,%ebx
    1253:	49 8d ba 00 fc ff ff 	lea    -0x400(%r10),%rdi
    125a:	4c 89 f6             	mov    %r14,%rsi
    125d:	7e 3d                	jle    129c <main+0x1ec>
    125f:	90                   	nop
    ...
    1283:	48 81 f9 00 04 00 00 	cmp    $0x400,%rcx
    128a:	75 e4                	jne    1270 <main+0x1c0>
    128c:	48 83 c7 08          	add    $0x8,%rdi
    1290:	48 81 c6 00 40 00 00 	add    $0x4000,%rsi
    1297:	4c 39 d7             	cmp    %r10,%rdi
    129a:	75 c4                	jne    1260 <main+0x1b0>
    129c:	48 81 c2 00 40 00 00 	add    $0x4000,%rdx
    12a3:	49 81 c2 00 40 00 00 	add    $0x4000,%r10
    12aa:	4c 39 e2             	cmp    %r12,%rdx
    12ad:	75 a1                	jne    1250 <main+0x1a0>
    12af:	8b 7d 80             	mov    -0x80(%rbp),%edi
    12b2:	48 8b b5 60 ff ff ff 	mov    -0xa0(%rbp),%rsi
    12b9:	49 83 e9 80          	sub    $0xffffffffffffff80,%r9
    12bd:	48 81 c6 00 04 00 00 	add    $0x400,%rsi
    12c4:	49 81 f9 00 08 00 00 	cmp    $0x800,%r9
    12cb:	0f 85 4c ff ff ff    	jne    121d <main+0x16d>
    ...
    12e5:	48 81 fa 00 08 00 00 	cmp    $0x800,%rdx
    12ec:	49 89 d5             	mov    %rdx,%r13
    12ef:	0f 85 e7 fe ff ff    	jne    11dc <main+0x12c>
    12f5:	49 89 c1             	mov    %rax,%r9
    12f8:	49 83 ef 80          	sub    $0xffffffffffffff80,%r15
    12fc:	48 81 c1 00 00 20 00 	add    $0x200000,%rcx
    1303:	49 81 c1 00 00 20 00 	add    $0x200000,%r9
    130a:	49 81 ff 00 08 00 00 	cmp    $0x800,%r15
    ...
    1398:	ba 00 08 00 00       	mov    $0x800,%edx
    ...
    140e:	48 81 c3 00 40 00 00 	add    $0x4000,%rbx
    1415:	e8 46 fc ff ff       	call   1060 <fputc@plt>
    141a:	48 81 fb 00 00 fa 00 	cmp    $0xfa0000,%rbx

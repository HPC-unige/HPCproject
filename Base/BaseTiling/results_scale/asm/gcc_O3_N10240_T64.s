...
results_scale/bin/gcc_O3_N10240_T64:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    1107:	ba 00 00 00 32       	mov    $0x32000000,%edx
    ...
    111e:	ba 00 00 00 32       	mov    $0x32000000,%edx
    ...
    1174:	00 
    1175:	48 8d bf 08 00 00 32 	lea    0x32000008(%rdi),%rdi
    ...
    11d4:	48 81 fe 00 40 01 00 	cmp    $0x14000,%rsi
    11db:	75 e4                	jne    11c1 <main+0x111>
    11dd:	49 81 c0 00 40 01 00 	add    $0x14000,%r8
    11e4:	48 81 c1 00 40 01 00 	add    $0x14000,%rcx
    11eb:	48 05 00 40 01 00    	add    $0x14000,%rax
    11f1:	48 81 c2 00 40 01 00 	add    $0x14000,%rdx
    ...
    1234:	48 8d 04 b6          	lea    (%rsi,%rsi,4),%rax
    1238:	48 c1 e0 0b          	shl    $0xb,%rax
    ...
    12e0:	49 81 c1 00 40 01 00 	add    $0x14000,%r9
    12e7:	4d 39 e2             	cmp    %r12,%r10
    12ea:	75 c4                	jne    12b0 <main+0x200>
    12ec:	48 81 c1 00 40 01 00 	add    $0x14000,%rcx
    12f3:	49 81 c2 00 40 01 00 	add    $0x14000,%r10
    ...
    131f:	48 3d 00 28 00 00    	cmp    $0x2800,%rax
    ...
    133c:	49 81 c6 00 00 50 00 	add    $0x500000,%r14
    1343:	48 81 ff 00 28 00 00 	cmp    $0x2800,%rdi
    ...
    1390:	48 81 fe 00 40 01 00 	cmp    $0x14000,%rsi
    1397:	75 e1                	jne    137a <main+0x2ca>
    1399:	e9 3f fe ff ff       	jmp    11dd <main+0x12d>
    139e:	48 8d 70 40          	lea    0x40(%rax),%rsi
    13a2:	49 81 c0 00 00 50 00 	add    $0x500000,%r8
    13a9:	48 81 c1 00 00 50 00 	add    $0x500000,%rcx
    13b0:	48 89 f0             	mov    %rsi,%rax
    13b3:	48 81 fe 00 28 00 00 	cmp    $0x2800,%rsi
    ...
    1441:	ba 00 28 00 00       	mov    $0x2800,%edx
    ...
    14b7:	49 81 c6 00 40 01 00 	add    $0x14000,%r14
    14be:	e8 9d fb ff ff       	call   1060 <fputc@plt>
    14c3:	49 81 fe 00 00 e2 04 	cmp    $0x4e20000,%r14

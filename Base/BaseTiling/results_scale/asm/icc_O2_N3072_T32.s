...
results_scale/bin/icc_O2_N3072_T32:     file format elf64-x86-64
...
00000000004012a0 <main>:
  ...
  40147e:	44 8d 46 20          	lea    0x20(%rsi),%r8d
  ...
  401499:	49 c1 e6 05          	shl    $0x5,%r14
  ...
  4014ac:	48 c1 e7 12          	shl    $0x12,%rdi
  ...
  4014f6:	41 8d 4b 20          	lea    0x20(%r11),%ecx
  ...
  401557:	44 8d 66 20          	lea    0x20(%rsi),%r12d
  ...
  40158a:	49 c1 e7 08          	shl    $0x8,%r15
  ...
  401810:	41 83 c0 e0          	add    $0xffffffe0,%r8d
  401814:	83 c6 20             	add    $0x20,%esi
  401817:	40 80 ff 60          	cmp    $0x60,%dil
  ...
  401836:	48 83 c2 20          	add    $0x20,%rdx
  40183a:	4c 8b 64 24 68       	mov    0x68(%rsp),%r12
  40183f:	49 83 c5 e0          	add    $0xffffffffffffffe0,%r13
  401843:	44 8b 5c 24 70       	mov    0x70(%rsp),%r11d
  401848:	49 81 c4 00 00 0c 00 	add    $0xc0000,%r12
  40184f:	41 83 c3 20          	add    $0x20,%r11d
  401853:	80 fb 60             	cmp    $0x60,%bl
  401856:	0f 82 95 fc ff ff    	jb     4014f1 <main+0x251>
  40185c:	8a 4c 24 48          	mov    0x48(%rsp),%cl
  401860:	fe c1                	inc    %cl
  401862:	8b 74 24 18          	mov    0x18(%rsp),%esi
  401866:	83 c6 20             	add    $0x20,%esi
  401869:	80 f9 60             	cmp    $0x60,%cl

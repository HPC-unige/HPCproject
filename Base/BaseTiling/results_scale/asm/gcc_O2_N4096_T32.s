...
results_scale/bin/gcc_O2_N4096_T32:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    1233:	45 8d 58 20          	lea    0x20(%r8),%r11d
    ...
    1273:	4d 8d b9 00 ff ff ff 	lea    -0x100(%r9),%r15
    ...
    12a5:	48 3d 00 01 00 00    	cmp    $0x100,%rax
    12ab:	75 e3                	jne    1290 <main+0x1e0>
    12ad:	49 83 c7 08          	add    $0x8,%r15
    12b1:	49 81 c5 00 80 00 00 	add    $0x8000,%r13
    12b8:	4d 39 cf             	cmp    %r9,%r15
    12bb:	75 c3                	jne    1280 <main+0x1d0>
    12bd:	48 81 c1 00 80 00 00 	add    $0x8000,%rcx
    12c4:	49 81 c1 00 80 00 00 	add    $0x8000,%r9
    ...
    12e5:	49 83 c0 20          	add    $0x20,%r8
    12e9:	48 81 45 88 00 01 00 	addq   $0x100,-0x78(%rbp)
    12f0:	00 
    12f1:	49 81 f8 00 10 00 00 	cmp    $0x1000,%r8
    12f8:	0f 85 31 ff ff ff    	jne    122f <main+0x17f>
    12fe:	49 81 c7 00 00 10 00 	add    $0x100000,%r15
    1305:	48 81 ff 00 10 00 00 	cmp    $0x1000,%rdi
    ...
    132c:	49 81 c4 00 00 10 00 	add    $0x100000,%r12
    1333:	49 89 c6             	mov    %rax,%r14
    1336:	89 cb                	mov    %ecx,%ebx
    1338:	49 89 d5             	mov    %rdx,%r13
    133b:	49 81 c1 00 00 10 00 	add    $0x100000,%r9
    1342:	48 81 fa 00 10 00 00 	cmp    $0x1000,%rdx
    ...
    1446:	49 81 c7 00 80 00 00 	add    $0x8000,%r15
    144d:	e8 0e fc ff ff       	call   1060 <fputc@plt>
    1452:	49 81 ff 00 00 f4 01 	cmp    $0x1f40000,%r15

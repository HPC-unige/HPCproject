...
results_scale/bin/gcc_O3_N1024_T32:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    1107:	ba 00 00 80 00       	mov    $0x800000,%edx
    ...
    111e:	ba 00 00 80 00       	mov    $0x800000,%edx
    ...
    1174:	00 
    1175:	48 8d bf 08 00 80 00 	lea    0x800008(%rdi),%rdi
    ...
    11d4:	48 81 fe 00 20 00 00 	cmp    $0x2000,%rsi
    11db:	75 e4                	jne    11c1 <main+0x111>
    11dd:	49 81 c0 00 20 00 00 	add    $0x2000,%r8
    11e4:	48 81 c1 00 20 00 00 	add    $0x2000,%rcx
    11eb:	48 05 00 20 00 00    	add    $0x2000,%rax
    11f1:	48 81 c2 00 20 00 00 	add    $0x2000,%rdx
    ...
    1225:	8d 42 20             	lea    0x20(%rdx),%eax
    1228:	39 d0                	cmp    %edx,%eax
    122a:	0f 8e 76 01 00 00    	jle    13a6 <main+0x2f6>
    1230:	48 83 c2 20          	add    $0x20,%rdx
    1234:	31 c0                	xor    %eax,%eax
    1236:	49 89 d6             	mov    %rdx,%r14
    1239:	49 c1 e6 0a          	shl    $0xa,%r14
    123d:	8d 70 20             	lea    0x20(%rax),%esi
    1240:	39 c6                	cmp    %eax,%esi
    1242:	48 8d 70 20          	lea    0x20(%rax),%rsi
    1246:	0f 8e fe 00 00 00    	jle    134a <main+0x29a>
    124c:	48 c1 e0 0d          	shl    $0xd,%rax
    ...
    126f:	8d 78 20             	lea    0x20(%rax),%edi
    ...
    12ad:	00 00 00 
    12b0:	4d 8d bb 00 ff ff ff 	lea    -0x100(%r11),%r15
    ...
    12e4:	48 3d 00 01 00 00    	cmp    $0x100,%rax
    12ea:	75 e4                	jne    12d0 <main+0x220>
    12ec:	49 83 c7 08          	add    $0x8,%r15
    12f0:	49 81 c6 00 20 00 00 	add    $0x2000,%r14
    12f7:	4d 39 fb             	cmp    %r15,%r11
    12fa:	75 c4                	jne    12c0 <main+0x210>
    12fc:	48 81 c7 00 20 00 00 	add    $0x2000,%rdi
    1303:	49 81 c3 00 20 00 00 	add    $0x2000,%r11
    ...
    1324:	48 83 c0 20          	add    $0x20,%rax
    1328:	49 81 c2 00 01 00 00 	add    $0x100,%r10
    132f:	48 3d 00 04 00 00    	cmp    $0x400,%rax
    ...
    134a:	48 81 fe 00 04 00 00 	cmp    $0x400,%rsi
    ...
    1398:	48 81 fe 00 20 00 00 	cmp    $0x2000,%rsi
    139f:	75 e1                	jne    1382 <main+0x2d2>
    13a1:	e9 37 fe ff ff       	jmp    11dd <main+0x12d>
    13a6:	48 83 c2 20          	add    $0x20,%rdx
    13aa:	49 81 c1 00 00 04 00 	add    $0x40000,%r9
    13b1:	49 81 c0 00 00 04 00 	add    $0x40000,%r8
    13b8:	48 81 fa 00 04 00 00 	cmp    $0x400,%rdx
    ...
    1446:	ba 00 04 00 00       	mov    $0x400,%edx
    ...
    14bc:	49 81 c6 00 20 00 00 	add    $0x2000,%r14
    14c3:	e8 98 fb ff ff       	call   1060 <fputc@plt>
    14c8:	49 81 fe 00 00 7d 00 	cmp    $0x7d0000,%r14

...
results_scale/bin/gcc_O3_N2048_T32:     file format elf64-x86-64
...
00000000000010b0 <main>:
    ...
    1266:	8d 48 20             	lea    0x20(%rax),%ecx
    ...
    12a0:	4d 8d bb 00 ff ff ff 	lea    -0x100(%r11),%r15
    ...
    12e0:	49 81 c1 00 40 00 00 	add    $0x4000,%r9
    12e7:	4d 39 fb             	cmp    %r15,%r11
    12ea:	75 c4                	jne    12b0 <main+0x200>
    12ec:	48 81 c1 00 40 00 00 	add    $0x4000,%rcx
    12f3:	49 81 c3 00 40 00 00 	add    $0x4000,%r11
    ...
    131f:	48 3d 00 08 00 00    	cmp    $0x800,%rax
    ...
    1335:	49 81 c6 00 00 08 00 	add    $0x80000,%r14
    133c:	48 81 ff 00 08 00 00 	cmp    $0x800,%rdi
    ...
    1388:	48 81 fe 00 40 00 00 	cmp    $0x4000,%rsi
    138f:	75 e1                	jne    1372 <main+0x2c2>
    1391:	e9 4a fe ff ff       	jmp    11e0 <main+0x130>
    1396:	48 8d 70 20          	lea    0x20(%rax),%rsi
    139a:	49 81 c0 00 00 08 00 	add    $0x80000,%r8
    13a1:	48 81 c1 00 00 08 00 	add    $0x80000,%rcx
    13a8:	48 89 f0             	mov    %rsi,%rax
    13ab:	48 81 fe 00 08 00 00 	cmp    $0x800,%rsi
    ...
    1439:	ba 00 08 00 00       	mov    $0x800,%edx
    ...
    14af:	49 81 c6 00 40 00 00 	add    $0x4000,%r14
    14b6:	e8 a5 fb ff ff       	call   1060 <fputc@plt>
    14bb:	49 81 fe 00 00 fa 00 	cmp    $0xfa0000,%r14

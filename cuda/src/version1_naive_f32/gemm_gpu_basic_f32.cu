...
/* =========================== CUDA Kernel: Naive FP32 ========================== */

__global__ void sgemm_plain_global_kernel(const float *PTR_NOALIAS lhs,
...
int main(void) {
    ...
    sgemm_plain_global_kernel<<<launch_grid, launch_threads>>>(
        dev_left,
        dev_right,
        dev_out,
        dim_n
    ...
    printf("[cuda-global-naive-sgemm] N=%d tile=%dx%d elapsed=%.6f s gflops=%.3f\n",
           dim_n,
           TILE_W,
           TILE_H,
           elapsed_sec,

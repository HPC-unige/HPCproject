...
readonly CUDA_SOURCE_FILE="gemm_gpu_basic_f64.cu"

readonly RESULTS_DIR="results_cuda/gemm_gpu_basic_f64"
readonly EXECUTABLE_DIR="${RESULTS_DIR}/bin"
readonly RESULTS_CSV_PATH="${RESULTS_DIR}/gemm_gpu_basic_f64.csv"
readonly LOG_PATH="${RESULTS_DIR}/gemm_gpu_basic_f64.log"
...
readonly RUN_FINGERPRINT="SRC=${CUDA_SOURCE_FILE}|FLAGS=${COMMON_NVCC_FLAGS}|HEADER=${CSV_HEADER}|CASESET=naive_f64_v1"
...
build_executable() {
    ...
    local executable_path="${EXECUTABLE_DIR}/naive_f64_N${dim_n}_T${tile_w}x${tile_h}"
